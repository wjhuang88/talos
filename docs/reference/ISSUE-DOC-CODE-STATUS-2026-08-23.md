...
| [#278](https://github.com/wjhuang88/talos/issues/278) | Bounded provider retry progress contract | [PROVIDER-006](../backlog/active/PROVIDER-006-bounded-retry-progress-contract.md) | Review / Claimed | Retry ordinals passed; planned I231/TUI-060/#332 owns initial connection and first-turn queue defects. |
...
| [#332](https://github.com/wjhuang88/talos/issues/332) | Initial connection and queue status sequencing | [TUI-060](../backlog/active/TUI-060-initial-connection-and-queue-status-sequencing.md) | Planned / Unclaimed | I231 is the selected corrective iteration; claim and activation remain ineffective until governance PR merges. |
