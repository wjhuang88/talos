...
| [#332](https://github.com/wjhuang88/talos/issues/332) | Initial connection and queue status sequencing | [TUI-060](../backlog/active/TUI-060-initial-connection-and-queue-status-sequencing.md) | Active / Claimed | I231 / PR #420 proposes the effective claim; activation and implementation remain ineffective until governance merge. |
