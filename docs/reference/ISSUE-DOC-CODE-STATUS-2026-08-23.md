...
| [#330](https://github.com/wjhuang88/talos/issues/330) | Permission prompt composer-relative docking | [TUI-059](../backlog/active/TUI-059-permission-prompt-composer-docking.md) | Planned / Unclaimed | I230 is the selected corrective iteration; claim and activation remain ineffective until governance PR merges. |
