...
| [#330](https://github.com/wjhuang88/talos/issues/330) | Permission prompt composer-relative docking | [TUI-059](../backlog/active/TUI-059-permission-prompt-composer-docking.md) | Active / Claimed | I230 / PR #416 proposes the effective claim; activation and implementation remain ineffective until governance merge. |
