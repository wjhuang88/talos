...
| [#188](https://github.com/wjhuang88/talos/issues/188) | model-assisted cross-surface `auto` permission decisions | [PERM-007](../backlog/active/PERM-007-model-assisted-goal-permission-decisions.md) | In Progress; A/I218 Complete, B/I233 Active / Claimed (proposed by #426), C-D Blocked | ADR-064 and PERM-006-A/B/C are complete; I233 claim/activation is ineffective until #426 merges and covers config/session control only, with no model or permission-result authority. |
