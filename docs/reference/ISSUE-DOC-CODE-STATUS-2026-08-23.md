...
| [#330](https://github.com/wjhuang88/talos/issues/330) | Permission prompt composer-relative docking | [TUI-059](../backlog/active/TUI-059-permission-prompt-composer-docking.md) | Review / Claimed | I230 claim PR #416 merged as `0f17e79d`; implementation candidate is locally converged and awaits exact-head CI/review. |
