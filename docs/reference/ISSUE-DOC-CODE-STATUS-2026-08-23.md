...
| [#278](https://github.com/wjhuang88/talos/issues/278) | Bounded provider retry progress contract | [PROVIDER-006](../backlog/active/PROVIDER-006-bounded-retry-progress-contract.md) | Review / Claimed | Retry ordinals passed; Review/Claimed I231/TUI-060/#332 has a local corrective candidate awaiting exact-head gates. |
...
| [#332](https://github.com/wjhuang88/talos/issues/332) | Initial connection and queue status sequencing | [TUI-060](../backlog/active/TUI-060-initial-connection-and-queue-status-sequencing.md) | Review / Claimed | I231 claim #420 merged as `27f64b70`; local candidate awaits exact-head CI/review. |
