...
| [#188](https://github.com/wjhuang88/talos/issues/188) | model-assisted cross-surface `auto` permission decisions | [PERM-007](../backlog/active/PERM-007-model-assisted-goal-permission-decisions.md) | In Progress; A/I218 Complete, B/I233 Review / Claimed, C-D Blocked | ADR-064 and PERM-006-A/B/C are complete; claim #426 merged as `7f47f9c3`, and I233 implementation is under exact-head validation for config/session control only. |
