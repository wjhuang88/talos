...
| [#267](https://github.com/wjhuang88/talos/issues/267) | Steering follow-up sequence | [TUI-048](../backlog/active/TUI-048-steering-esc-activation.md) | Complete / Closed | I206 completed through PR #411 merge `9d7c87cb` from exact head `c742eea5`; CI `33063880465` attempt 2 and independent approval `5438243363` passed. I207/I208 remain Planned/Unclaimed. |
...
| [#329](https://github.com/wjhuang88/talos/issues/329) | Permission-mediated marker and unnamed outcome correlation | [TUI-058](../backlog/active/TUI-058-permission-mediated-tool-activity-correlation.md) | Ready / Unclaimed | Separate iteration and effective claim required. |
