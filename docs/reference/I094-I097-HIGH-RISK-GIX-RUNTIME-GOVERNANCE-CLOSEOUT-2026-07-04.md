...
| `VALIDATION-001` | Convert I095 validation evidence into a language-neutral internal service. Governance validation should be in-process; Cargo is only a Rust-project host-tool adapter, not a generic agent assumption; host-tool adapter guidance should be injected only after project type detection. |
