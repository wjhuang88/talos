...
| [#134](https://github.com/wjhuang88/talos/issues/134) | native text selection and copy | [TUI-046](../backlog/active/TUI-046-native-text-selection-copy.md) | Refinement | A decides ADR-054 mouse-capture policy; B implements and proves exact-head two-terminal acceptance. |
