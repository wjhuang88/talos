...
| [#270](https://github.com/wjhuang88/talos/issues/270) | Preserve UTF-8 across SSE transport chunks | [PROVIDER-005](../backlog/active/PROVIDER-005-streaming-utf8-chunk-boundary.md) | Complete / Closed | Completion Commit `1d31847a`; PR #271 merged as `89523dbc` after exact-head CI `32002811484`, independent approval `5313112992` and CAS. Close the remote Issue after this owner-first closeout reaches main. |
