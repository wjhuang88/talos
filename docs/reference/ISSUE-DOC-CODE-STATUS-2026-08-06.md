...
| [#272](https://github.com/wjhuang88/talos/issues/272) | Resumed Session interactivity under provider delay | [TUI-051](../backlog/active/TUI-051-resumed-session-interactivity.md) | Completed | Completion Commit `2eff6285`, source implementation `7b82fea6`/`7d90def8`, CI `32025371877`, real-terminal evidence and independent agent audit `5316533941`. Truthful retry progress remains transferred to #278. |
