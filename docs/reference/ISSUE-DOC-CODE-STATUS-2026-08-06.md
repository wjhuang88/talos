...
| [#49](https://github.com/wjhuang88/talos/issues/49) | bounded graceful shutdown | [RUNTIME-005](../backlog/active/RUNTIME-005-bounded-graceful-shutdown.md) | Ready / Unclaimed | A/I214 is Complete and ADR-063 Accepted at `6719c876`; B requires a new iteration/effective claim, C waits for B, and TOOL-024 remains a downstream consumer. |
