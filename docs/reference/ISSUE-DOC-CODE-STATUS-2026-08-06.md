...
| [#134](https://github.com/wjhuang88/talos/issues/134) | native text selection and copy | [TUI-046](../backlog/active/TUI-046-native-text-selection-copy.md) | Active | I184/A is Complete; B is ready for a separate claim and exact-head two-terminal acceptance remains required. |
