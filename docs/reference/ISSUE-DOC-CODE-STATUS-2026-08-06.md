...
| [#339](https://github.com/wjhuang88/talos/issues/339) | Local convergence and stable-stage validation | [GOV-008](../backlog/active/GOV-008-local-convergence-stage-validation.md) | Complete / Closed | Completion Commit `06e61e3c`; PR #341 merged as `81a603b4` after CI `32442052401`, review `5365129718` and CAS. |
