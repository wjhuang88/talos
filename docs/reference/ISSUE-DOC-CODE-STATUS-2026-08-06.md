...
| [#188](https://github.com/wjhuang88/talos/issues/188) | model-assisted cross-surface `auto` permission decisions | [PERM-007](../backlog/active/PERM-007-model-assisted-goal-permission-decisions.md) | In Progress; decision-only I218 Active/Claimed from PR #352 merge `ca30081a` | [PERM-007-A](../backlog/active/PERM-007-A-auto-permission-security-decision.md) / [I218](../iterations/I218-perm007a-auto-permission-security-decision.md) own the threat matrix and Proposed ADR-064. Default-on remains unaccepted and no behavior authority exists before independent decision review and later PERM-006/child gates. |
