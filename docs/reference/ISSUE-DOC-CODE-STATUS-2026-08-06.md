...
| [#302](https://github.com/wjhuang88/talos/issues/302) | Deferred human review and terminal acceptance batch | [VALIDATION-002](../backlog/active/VALIDATION-002-deferred-human-validation-batch.md) | Ready / I211 Planned / Unclaimed | PR #303 proposes Deferred Human Validation Mode and this evidence-only cleanup owner; neither the scheduling amendment nor I211 activation is effective before merge. |
