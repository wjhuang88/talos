...
| [#278](https://github.com/wjhuang88/talos/issues/278) | Bounded provider retry progress contract | [PROVIDER-006](../backlog/active/PROVIDER-006-bounded-retry-progress-contract.md) | Active / Claimed | ADR-062 accepted; claim #321 exact head `4d45f1ba` passed review/CI/CAS and merged as `e58fbd39`. I210 implementation may start from this or later main; no release/publication authority. |
