...
| [#339](https://github.com/wjhuang88/talos/issues/339) | Local convergence and stable-stage validation | [GOV-008](../backlog/active/GOV-008-local-convergence-stage-validation.md) | Review / Claimed | Atomic claim+activation PR #340 merged as `e66d039c`; locally converged governance candidate awaits exact-head validation and authorizes no product/runtime change. |
