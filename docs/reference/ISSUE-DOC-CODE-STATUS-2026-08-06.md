...
| [#278](https://github.com/wjhuang88/talos/issues/278) | Bounded provider retry progress contract | [PROVIDER-006](../backlog/active/PROVIDER-006-bounded-retry-progress-contract.md) | Active / Claimed through PR #321 target merge; ineffective while open | ADR-062 and the bounded I210 claim are proposed in #321. Independent exact-head review, CI and CAS must pass before target merge; no public API or implementation authority exists while open. |
