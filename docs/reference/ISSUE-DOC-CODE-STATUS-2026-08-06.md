...
| [#339](https://github.com/wjhuang88/talos/issues/339) | Local convergence and stable-stage validation | [GOV-008](../backlog/active/GOV-008-local-convergence-stage-validation.md) | Active / Claimed only when PR #340 merges | I215 atomic claim+activation pilot; the open PR has no ownership effect and authorizes no product/runtime change. |
