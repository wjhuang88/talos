...
| [#302](https://github.com/wjhuang88/talos/issues/302) | Deferred human review and terminal acceptance batch | [VALIDATION-002](../backlog/active/VALIDATION-002-deferred-human-validation-batch.md) | In Progress / I211 Active / Claimed | Activation PR #328 merged as `a2f43248`; partial evidence is classified, two failures have corrective owners and remaining rows stay open. |
