...
| [#54](https://github.com/wjhuang88/talos/issues/54) | scoped grant stores | [PERM-006-B](../backlog/active/PERM-006-B-scoped-grant-store.md) | Ready / Unclaimed | PERM-006-A dependency is complete; ADR-066 acceptance plus a separate runnable iteration and effective claim still gate implementation. |
...
|---|---|---|---|
| [#53](https://github.com/wjhuang88/talos/issues/53) | PERM-006-A / I189 | Completed | Completion Commit `6b577d6afcb05230c821214902b9067c45c767a9`; implementation PR #356 merged as `54241bdde83141f5f40e1ee477210217df55e2e9` after exact-head CI `32511672926`, independent Agent-role permission/security/code review `5376591491` and CAS; owner-first closeout PR #357 merged as `82d361b821767ad6ef9ec10539a33b1b15cdaf0c`. |
