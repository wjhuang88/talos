...
- Issue #132 is assigned to existing PROVIDER-003 because that Story already owns dynamic provider credentials; this synchronization does not authorize provider-auth implementation.
