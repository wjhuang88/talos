...
| Priority | P1 |
| Status | Complete / Closed — SESSION-008-A/B/C complete |
...
| SESSION-008-C | Display-safe interrupted marker projection and restart parity | Complete in I263; Completion Commit `0f021a6f` | SESSION-008-B Complete; PR #546 merged `239a01cc` |
