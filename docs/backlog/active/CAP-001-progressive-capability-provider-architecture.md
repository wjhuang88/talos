...
2026-09-20 resolution: CAP-001-D / I278 delivered this recovered source requirement in #576,
merge `1e5a8592a2b14cfb0279837c1c5f2137ddc4a4c7`. The child completion ledger carries real-artifact
acceptance, exact-head CI and independent review/CAS. The earlier correction remains historical.
...
|---|---|---|
| [CAP-001-D](CAP-001-D-root-plugin-source-layout.md) / source #466 | Deliver omitted root `plugins/` implementation source and independent build/package path. | I278 Complete / Closed; #576 merged as 1e5a8592 with exact-head CI/review/CAS. Root source delivery residual resolved; I277 human acceptance remains Deferred. |
...
| BUNDLE-001 / Issue #514 | Bundle manifest, installation identity and terminology migration. | I259 Complete / Closed; Completion Commit `137da646`; implementation #539 merged `137da646` |
...
| LANG-002 / Issue #516 | Rust WASM Language Provider vertical slice. | Planned / Claimed (proposed; ineffective until claim PR #542 merges); implementation unauthorized |
...
Completion Commit `e1b9997a`. I256/TEXT-001 claim/activation became effective through #530
merge `c8b59698`; all other remaining children stay unclaimed.
