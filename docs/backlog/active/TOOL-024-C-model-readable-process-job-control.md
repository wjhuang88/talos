...
| Implementation PR | #386 — exact head `eabb7d3a` |
...
Stable implementation commit: `dcdffc56` plus launch-cancel reap fix `eabb7d3a`; implementation PR #386 is open at exact head `eabb7d3a`.
