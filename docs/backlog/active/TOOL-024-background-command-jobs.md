...
| [TOOL-024-D1-B](TOOL-024-D1-B-windows-job-object-ownership.md) | Windows Job Object Process-Tree Ownership | Product/Process-Security Story | Review / Claimed | TOOL-024-D1-A Complete; ADR-068 Accepted | PR #394 candidate `b6c6e387` is under fresh exact-head validation after Clippy corrections; implementation remains fail-closed until CI and independent review pass. |
