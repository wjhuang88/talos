...
| [TOOL-024-D1-B](TOOL-024-D1-B-windows-job-object-ownership.md) | Windows Job Object Process-Tree Ownership | Product/Process-Security Story | Planned / Claimed proposal | TOOL-024-D1-A Complete; ADR-068 Accepted | Assigned-before-exec Job Object implementation with kill-on-close and real Windows child/grandchild cleanup evidence; claim becomes effective only if I226 governance PR merges. |
