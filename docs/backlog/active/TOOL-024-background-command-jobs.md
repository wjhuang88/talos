...
| TOOL-024-D1-B | Windows Job Object Process-Tree Ownership | Product/Process-Security Story | Ready / Unclaimed | TOOL-024-D1-A Complete; ADR-068 Accepted | Assigned-before-exec Job Object implementation with kill-on-close and real Windows child/grandchild cleanup evidence; requires separate I226 claim. |
