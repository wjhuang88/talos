...
|---|---|---|---|
| 1 | Dependency baseline and upgrade governance / #474 | DEPENDENCY-001 / I248 Active/Claimed proposal in #496; ineffective until merge. Baseline, Bash/PowerShell audit, generic SOP and live candidate handoff; no actual dependency upgrades. | `docs/backlog/active/DEPENDENCY-001-dependency-upgrade-governance.md`; `docs/iterations/I248-dependency-governance-closed-loop.md`; `docs/tasks/2026-09-06-dependency-governance-recovery.md`; Issue #474 |
