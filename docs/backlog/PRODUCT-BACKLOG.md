...
| ARCH-034-R03 / I173 | In Progress / Active when Claim #148 merges | Claim-only Todo model/repository/formatting/tool-adapter decomposition; preserve public paths, SQL, schemas, permissions, contribution order, and output. |
