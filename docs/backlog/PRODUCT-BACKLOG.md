...
| 1 | Model-assisted auto permission decisions | PERM-007-A/I218 and PERM-007-B/I233 are Complete/Closed; PERM-007-C/I234 is Active / Claimed (proposed, ineffective until merge); D remains Blocked. I233 merged canonical config and session `/auto` status/control only. | `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md`; `docs/backlog/active/PERM-007-B-auto-config-session-command.md`; `docs/backlog/active/PERM-007-C-model-assisted-resolver.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/iterations/I233-perm007b-auto-config-session-command.md`; `docs/iterations/I234-perm007c-model-assisted-resolver.md`; ADR-064; Issue #188 |
