...
| 1 | Supervised background command jobs | I188/TOOL-024-A is Active through effective claim merge `02a35588`. Proposed ADR-060 makes B an explicit Unix-first slice; production still waits for accepted A, completed RUNTIME-005, PERM-006-C and TOOL-023-C. Windows remains fail-closed until D's separate Job Object gate; Issue #59 remains open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/decisions/060-supervised-background-command-jobs.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
