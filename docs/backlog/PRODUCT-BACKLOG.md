...
| 1 | Supervised background command jobs | TOOL-024-B/I222, C/I224, D1-A/I225 and D1-B/I226 are Complete/Closed. D2/I228 is proposed Active/Claimed for CLI/TUI projection and integrated Unix/Windows acceptance; I223 remains separate. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-D2-interactive-projection-and-acceptance.md`; `docs/iterations/I228-tool024d2-interactive-projection-and-acceptance.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md` |
