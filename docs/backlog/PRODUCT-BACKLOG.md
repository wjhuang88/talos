...
| 1 | Desktop D0 renderer/host boundary | `DESKTOP-001-D0` / I194 is Planned / Claim Pending through PR #211. The parent DESKTOP-001 remains Deferred / Unclaimed / Selected Iteration None; no GPUI, i18n, native dependency or Desktop implementation is authorized before the finalized child claim reaches `main` and D0 later accepts the renderer/host ADR. | `docs/backlog/active/DESKTOP-001-D0-renderer-host-boundary.md`; `docs/iterations/I194-desktop-renderer-host-boundary.md`; `docs/backlog/active/DESKTOP-001-desktop-product-direction.md`; ADR-042; ADR-052 |
