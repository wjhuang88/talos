...
| 1 | Supervised background command jobs | I188/TOOL-024-A, TOOL-023-C, RUNTIME-005 and PERM-006-C are Complete. TOOL-024-B is Ready/Unclaimed with Draft I222; activation still requires claim merge and explicit I213 scheduling. C/D and Issue #378/I223 remain ordered residuals; Windows fails closed. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-B-managed-background-execution-core.md`; `docs/iterations/I222-tool024b-managed-background-execution-core.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md` |
...
| I222 / TOOL-024-B managed background core | Planned / Unclaimed Draft | Technical prerequisites are Complete, but no authority exists before finalized claim merge and explicit I213 scheduling. Unix-only non-daemonizing supervisor core; no CLI/Dashboard/Windows process spawn. |
