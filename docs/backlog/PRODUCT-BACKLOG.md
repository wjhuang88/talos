...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is effective Claimed through #327 merge `66747214`. Activation PR #363 proposes it as Active under the maintainer-approved I219/I213 non-overlap exception; implementation remains unauthorized until #363 reaches `main`. It is GET/read-only observation only and cannot modify permission/runtime authority. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
|---|---|---|
| I219 / PERM-006-B | Active / Claimed | Effective through #359 merge `781bb112`; exclusive permission/grant/store/API authority. I213 parallel authorization does not transfer any permission scope. |
| I213 / WEB-001-B | Active / Claimed proposed via #363 | Effective claim through #327 merge `66747214`; implementation starts only after #363 reaches `main`, under the I219 file/authority/CAS protection contract. |
