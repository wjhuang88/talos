...
| 0 | Ordered mainline priority requirements | Coordination claim effective through #227 and Deferred Human Validation Mode amendment #303 merged as `99645e78`. I200 remains Review; I197 implementation merged through PR #305 as `d98f37e7` after local gates, exact-head CI, Agent technical review and CAS, and remains Review with human/manual rows deferred to Issue #302 / I211. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I198; I211 |
...
| 1 | TUI regression intake | TUI-041/#69 and I199 are Complete/Closed. TUI-042/#79 implementation merged as `9628e183`; I200 remains Review with its human rows tracked by effective VALIDATION-002/I211/#302. TUI-045/#125 implementation merged through PR #305 as `d98f37e7` and remains Review for the same deferred batch. TUI-043/#111 claim #306 is effective through merge `78cb1ddd`; implementation has not started and remains limited to its published TUI-visible boundary. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/iterations/I199-tui041-thinking-preview-wrap-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md` |
...
| 1 | Remaining TUI interaction intake | TUI-052/#266, TUI-053/#268, TUI-054/#269 and TUI-055/#280 remain Intake / Unclaimed; TUI-056/#298 is Refinement / Unclaimed. None has a selected iteration, and each requires decomposition or boundary checks before selection. TUI-051/#272 is Complete through I209. | `docs/backlog/active/TUI-052-todo-rendering-muted-readability.md`; `docs/backlog/active/TUI-053-numeric-permission-shortcuts.md`; `docs/backlog/active/TUI-054-native-key-repeat-routing.md`; `docs/backlog/active/TUI-055-narrow-markdown-table-layout.md`; `docs/backlog/active/TUI-056-collapsible-reasoning-history.md`; `docs/backlog/active/TUI-051-resumed-session-interactivity.md` |
...
| TUI-043 / I201 | Active / Claimed | Implement only the effective #306 TUI-visible compatibility-display slice; preserve legitimate assistant text and ordered tool rows. |
