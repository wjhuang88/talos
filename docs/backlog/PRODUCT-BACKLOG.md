...
| 0 | Goal-oriented work and evaluation foundation | WORK-001-A / I196 is Active / Claimed from activation checkpoint `main@b59912e3`; P0 remains decision/documentation-only and non-overlapping with Dashboard I195. P1-P4 remain separate and unactivated. | `docs/backlog/active/WORK-001-goal-oriented-work-evaluation-foundation.md`; `docs/backlog/active/WORK-001-A-work-domain-decision-migration-contract.md`; `docs/iterations/I196-work-domain-decision-migration-contract.md`; DESKTOP-001; RUNTIME-001; SESSION-009; TODO-001; TODO-002; VALIDATION-001 |
| 0 | Ordered mainline priority requirements | Coordination claim effective through #227. I188 is Complete; GOV-007/I205 is Complete/Closed; next ordered item is a fresh exact-main I196 inventory. No child is activated solely by the long task. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I198 |
...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is Complete/Closed at Completion Commit `2eff6285`, with source implementation `7b82fea6`/`7d90def8`, exact-head CI `32025371877`, real-terminal acceptance and independent agent audit `5316533941`. Retry progress remains separately Planned/Unclaimed in PROVIDER-006/I210. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; Issue #272; PR #279 |
| 1 | Bounded provider retry progress contract | PROVIDER-006 / I210 is Planned / Unclaimed from Issue #278. It requires an ADR before a semver-compatible public progress contract can expose actual attempt/backoff facts; no implementation authority exists. | `docs/backlog/active/PROVIDER-006-bounded-retry-progress-contract.md`; `docs/iterations/I210-provider-retry-progress-contract.md`; Issue #278 |
...
| 1 | Dashboard read-only visual shell | WEB-001-A / I195 is In Progress / Active / Claimed through claim merge `f123e534` and activation PR #288. Existing #233 remains Draft provenance and must be rebuilt from the activation merge or later current `main`; the slice remains GET-only/read-only Dashboard IA/UX and imports no I205, release, Runtime, Desktop or TUI authority. | `docs/backlog/active/WEB-001-A-dashboard-read-only-visual-shell.md`; `docs/iterations/I195-dashboard-read-only-visual-shell.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-031; three-track baseline |
...
| WORK-001-A / I196 | Active / Claimed | Claim PR #226 merged as `453d1fba`; P0 decision packet is active on the current main exact head. Implementation authority remains limited to the documented decision and migration contract. |
