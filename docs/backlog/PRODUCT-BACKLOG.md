...
| 0 | Model-first permission triage follow-up | PERM-007-E / I241 is Active / Claimed; ADR-069 is Accepted, and implementation is pending claim merge. | `docs/backlog/active/PERM-007-E-model-first-permission-triage.md`; `docs/iterations/I241-perm007e-model-first-permission-triage.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
