...
| 1 | PERM-007-C capability decision | I235 Planned / Unclaimed; decision-only prerequisite for I234; no implementation authority. | `docs/backlog/active/PERM-007-C0-atomic-create-capability-decision.md`; `docs/iterations/I235-perm007c-atomic-create-capability-decision.md`; ADR-064; Issue #188 |
