...
|---|---|---|---|
| 1 | Dependency baseline and upgrade governance / #474 | DEPENDENCY-001 / I248 Complete/Closed; #498 merged as `a7d168ee` (head `5d2e4443`, CI `34074942674`, review `5564114577`). Full upgrade is DEPENDENCY-002 / I250 Active/Claimed after #500 merge `ea9a4c37`; I249 remains an unselected one-package pilot. | `docs/backlog/active/DEPENDENCY-001-dependency-upgrade-governance.md`; `docs/iterations/I248-dependency-governance-closed-loop.md`; `docs/backlog/active/DEPENDENCY-002-full-workspace-dependency-upgrade.md`; `docs/iterations/I250-full-workspace-dependency-upgrade.md`; Issue #474 |
...
| 1 | Progressive capability provider architecture | CAP-001 / #466 remains Refinement / Unclaimed / unselected. Preparatory CAP-001-P0 / #467 is I246 Complete / Closed under claim #491 and implementation PR #492; it does not complete or authorize the full parent architecture. | `docs/backlog/active/CAP-001-progressive-capability-provider-architecture.md`; `docs/backlog/active/CAP-001-P0-progressive-capability-compatibility-preparation.md`; ADR-027; ADR-029; PLUGIN-001; TOOL-008; DIST-001; WEB-005 |
