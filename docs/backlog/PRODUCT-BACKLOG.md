...
|---|---|---|---|
| 1 | Dependency baseline and upgrade governance / #474 | DEPENDENCY-001 / I248 Review/Claimed; #497 merged, native Windows audit acceptance pending in #498. Full upgrade is DEPENDENCY-002 / I250 Planned/Unclaimed; I249 remains an unselected one-package pilot. | `docs/backlog/active/DEPENDENCY-001-dependency-upgrade-governance.md`; `docs/iterations/I248-dependency-governance-closed-loop.md`; `docs/backlog/active/DEPENDENCY-002-full-workspace-dependency-upgrade.md`; `docs/iterations/I250-full-workspace-dependency-upgrade.md`; Issue #474 |
