...
| 0 | PR workflow throughput simplification | GOV-007 / I205 is Ready / Planned / Claimed through #284, with activation still separate. Measure recent delivery churn and select a smaller evidence-preserving flow before changing executable governance. | `docs/backlog/active/GOV-007-pr-workflow-throughput-simplification.md`; `docs/iterations/I205-pr-workflow-throughput-simplification.md`; collaboration/Git/DOC-CHECK/CI SOPs |
