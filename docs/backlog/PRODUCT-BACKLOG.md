...
| 1 | Tombstone-pruning fixture performance | TEST-002 / I227 is Review / Claimed under implementation PR #399 from effective claim merge `c3f083ff`. Preserve permanent idempotency coverage and production retention limits while removing the Windows 60-second fixture delay; remain disjoint from I226 / PR #394. | `docs/backlog/active/TEST-002-tombstone-pruning-fixture-performance.md`; `docs/iterations/I227-test002-tombstone-pruning-fixture-performance.md`; `docs/sop/TESTING.md`; pending-submission storage/tests; Windows CI |
