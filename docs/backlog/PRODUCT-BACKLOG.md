...
| 1 | Custom-model context-window catalog inference | MODEL-013/#312 is Refinement / Unclaimed. Define conservative unique catalog matching, explicit-value precedence and provenance before a separate iteration/claim; no network or capability inference. | `docs/backlog/active/MODEL-013-catalog-context-window-inference.md`; `docs/backlog/active/MODEL-011-custom-model-capability-probe.md`; ADR-022 |
