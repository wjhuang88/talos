...
| --- | --- | --- | --- |
| 1 | Conversation context continuity (MEM-002 → I024) | P0 — agent cannot sustain multi-turn conversation without history. I024 is in Review: history wiring, JSONL resume, and layers 1-3 compaction are verified; LLM compaction residual moved to MEM-003. | `docs/backlog/active/MEM-002-conversation-context-continuity.md`; `docs/iterations/I024-conversation-context.md` |
| 2 | TUI logo & splash (TUI-005) + TUI completion (TUI-001) + code block rendering (TUI-006) | TUI-005 establishes brand identity; TUI-001 finishes deferred extensibility. TUI-006 sub-slice A (rounded border) is independent and can ship alongside TUI polish work; sub-slice B (syntax highlighting) is blocked on tree-sitter ADR. | `docs/backlog/active/TUI-005-logo-splash.md`; `docs/backlog/active/TUI-001-completion.md`; `docs/backlog/active/TUI-006-code-block-rendering.md` |
...
| 7.5 | Tree-sitter code analysis research + LLM-based compaction residuals | Code analysis needs a dependency/architecture spike before introducing tree-sitter. LLM compaction layers 4-5 were deferred from I024 and need provider access through the session actor. | `docs/backlog/active/CODE-001-tree-sitter-code-analysis-research.md`; `docs/backlog/active/MEM-003-llm-compaction.md` |
...
| MEM-002 | Conversation context continuity | **Review** (→ I024) | P0 | P0 — agent must sustain multi-turn conversation with current-session history. I024 is in Review with session history, JSONL resume, and layers 1-3 compaction evidence; final runtime evidence remains before Complete. | `docs/backlog/active/MEM-002-conversation-context-continuity.md`; `docs/iterations/I024-conversation-context.md`; `docs/roadmap/TWO-WEEK-HANDOFF-PLAN.md`; `docs/proposals/session-context-contamination.md`; ADR-016 |
