...
| 0 | Permission pipeline convergence | Claim merge `0df88638` is effective. I189/PERM-006-A becomes Active/Claimed only when governance PR #351 reaches `main`; implementation remains unauthorized before then. B-E remain blocked in order. PERM-007 remains Refinement/Unclaimed and outside this slice. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; PERM-006-B/C/D/E; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
