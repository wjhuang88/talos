...
| 0 | v0.8.0 release-candidate registry readiness | ARCH-031-E / I204 is Planned/Claimed through proposed claim PR #257. It addresses the I162 reviewed NO-GO with candidate-only `0.8.0` version alignment, registry visibility, metadata closure and package/dry-run evidence. I203 remains Blocked until a reviewed GO packet; no release or publication is authorized. | `docs/backlog/active/ARCH-031-E-v080-release-candidate-readiness.md`; `docs/iterations/I204-v080-release-candidate-readiness.md`; `docs/reference/I162-PUBLICATION-READINESS-2026-08-15.md`; `docs/iterations/I203-v080-github-and-crates-publication.md` |
