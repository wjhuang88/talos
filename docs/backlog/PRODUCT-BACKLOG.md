...
| 0 | Local convergence and stable-stage validation | GOV-008 / I215 is Review/Claimed after atomic claim+activation PR #340 merged as `e66d039c`; one locally converged SOP/validator/scenario candidate awaits exact-head stage validation. No product/runtime scope. | `docs/backlog/active/GOV-008-local-convergence-stage-validation.md`; `docs/iterations/I215-local-convergence-stage-validation.md`; Issue #339 |
...
| GOV-008 / I215 | Review / Claimed | Atomic claim+activation merged; locally converged rules and fixtures await one stable candidate's exact-head validation. [Story](active/GOV-008-local-convergence-stage-validation.md) / [Iteration](../iterations/I215-local-convergence-stage-validation.md) / Issue #339 |
