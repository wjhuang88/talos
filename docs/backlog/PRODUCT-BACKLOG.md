...
| ARCH-034-R04 / I181 / I182 / I183 | Partial / I183 Active | Review-only matrix completed at `aea26ad0`; [AG-4](active/ARCH-034-R04-AG4-symbol-traversal-containment.md) completed at `ae31242bdac4807599146bfb4847bcac52712bbf`. [AG-7](active/ARCH-034-R04-AG7-sqlite-adr-reconciliation.md) is active through [I183](../iterations/I183-sqlite-adr-reconciliation.md) after claim PR #183 merged at `7e614540`; implementation remains documentation/validation only. AG-1/2/3/5/6/8/9/10 and SQLite-containment residual AG-11 remain unclaimed. |
