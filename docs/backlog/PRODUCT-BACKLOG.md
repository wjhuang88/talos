...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is Active/Claimed through activation PR #363 merge `e578f419`. PR #379 remains the sole original I213/I222-B parallel-contract source; I222-B's proposed narrow reserved-`background:` permission matcher/test amendment adds no CLI/Dashboard/README/I213 authority and is ineffective until merged. Each lane requires separate exact-head evidence/CAS. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
| 1 | Supervised background command jobs | TOOL-024-B/I222 is Active/Claimed through #379 merge `48e8ae9b`, but implementation is paused before permission edits until a narrow reserved-`background:` matcher/test amendment reaches `main`. It changes no public permission schema, CLI, Dashboard or I213 authority. C/D and I223 remain ordered residuals; Windows fails closed. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-B-managed-background-execution-core.md`; `docs/iterations/I222-tool024b-managed-background-execution-core.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md` |
...
| I213 / WEB-001-B | Active / Claimed | Activation PR #363 merged as `e578f419`; PR #379 is the sole original I213/I222-B contract source. I222-B's pending reserved-`background:` permission matcher/test amendment excludes all I213 files/authority; every lane retains independent exact-head evidence and CAS. |
...
| I222 / TOOL-024-B managed background core | Active / Claimed; permission amendment pending | PR #379 merged as `48e8ae9b`; implementation is paused before permission edits until the narrow reserved-`background:` matcher/test amendment reaches `main`. No public permission schema, CLI/Dashboard/I213 or Windows spawn authority. |
