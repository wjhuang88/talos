...
| 0 | Ordered mainline priority requirements | Complete/Closed with owned residuals. T1-T10 have terminal dispositions and T11 is Complete; #59 remains Blocked on PERM-006-C plus separate TOOL-024 authority, while I197/I198/I201/I210 remain Review under corrective owners. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211; I214; I216; I217 |
...
| 0 | Permission pipeline convergence | A/I189, B/I219 and I220 are Complete/Closed; I221/PERM-006-C is Review/Claimed after claim #375 became effective at `main@d662501c`. ADR-067 is Accepted through #373 merge `5d2d2dcf`; implementation remains bounded to I221. C-E, `/auto` behavior and TOOL-024 remain unauthorized. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md`; `docs/iterations/I221-perm006c-agent-owned-pipeline.md`; `docs/iterations/I220-perm006c-agent-owned-pipeline-decision.md`; `docs/decisions/067-agent-owned-permission-pipeline.md` |
...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is Active/Claimed through activation PR #363 merge `e578f419`. Controlled exceptions cover existing I219/I213 permission-vs-Dashboard execution and decision-only I220/I213 ADR-067 documentation. I220 cannot change Dashboard/Runtime/permission implementation; authority or production overlap stops work, and each lane requires separate exact-head CI/review/CAS. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
| 1 | Supervised background command jobs | I188/TOOL-024-A, TOOL-023-C and all RUNTIME-005 children are Complete. Production B remains blocked on PERM-006-C and a separate effective child claim; Windows remains fail-closed pending D. Issue #59 stays open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
...
| I213 / WEB-001-B | Active / Claimed | Activation PR #363 merged as `e578f419`; I219/I213 retains its existing protection, while I220/I213 permits decision-only ADR-067 docs with no Rust/Cargo/Dashboard/Runtime/permission behavior. Both lanes retain independent exact-head evidence and CAS. |
| I220 / PERM-006-C decision prerequisite | Complete / Closed | Completion Commits `c21bb7f3`/`820586ea`; PR #373 merged as `5d2d2dcf`, ADR-067 Accepted. I221/#375 separately owns C implementation; claim ineffective until merge. |
| I221 / PERM-006-C implementation claim | Review / Claimed | Claim #375 is effective at `main@d662501c`; implementation candidate is locally converged within the exact ADR-067 boundary and awaits implementation PR evidence. |
