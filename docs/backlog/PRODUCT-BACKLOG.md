...
| 0 | Permission pipeline convergence | I189/PERM-006-A is Complete/Closed at Completion Commit `6b577d6a`; PR #356 merged as `54241bdd` after exact-head CI and independent review. PERM-006-B is Ready/Unclaimed. PERM-007-A/I218 remains Complete at Completion Commit `a289a07f`; ADR-064 was Accepted after exact-head security review and PR #353 merge `c129d4a5`. C-E and later `/auto` behavior remain blocked on ordered prerequisites and separate claims. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/backlog/active/PERM-006-B-scoped-grant-store.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; `docs/backlog/active/PERM-007-A-auto-permission-security-decision.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/decisions/064-bounded-model-assisted-auto-permission.md`; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
