...
| 0 | Permission pipeline convergence | A/I189, B/I219 and I220 are Complete/Closed; C is Ready/Unclaimed pending I221 claim. ADR-067 is Accepted through #373 merge `5d2d2dcf`; I221 later owns implementation. C-E, `/auto` behavior and TOOL-024 remain unauthorized. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md`; `docs/iterations/I220-perm006c-agent-owned-pipeline-decision.md`; `docs/decisions/067-agent-owned-permission-pipeline.md`; `docs/iterations/I219-perm006b-first-class-scoped-grants.md` |
...
| I220 / PERM-006-C decision prerequisite | Complete / Closed | Completion Commits `c21bb7f3`/`820586ea`; PR #373 merged as `5d2d2dcf`, ADR-067 Accepted. I221 separately owns C implementation. |
