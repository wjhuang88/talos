...
| 2 | TUI logo & splash (TUI-005) + TUI completion (TUI-001) | Logo establishes brand identity; completion finishes deferred extensibility. TUI-005 depends on I023 (Complete) for `TuiStateEvent::SplashComplete`. | `docs/backlog/active/TUI-005-logo-splash.md`; `docs/backlog/active/TUI-001-completion.md` |
