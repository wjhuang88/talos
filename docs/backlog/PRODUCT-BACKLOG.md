...
| 0 | Generic shell auto classifier | PERM-007-F0 / I243 Complete/Closed; ADR-070 Accepted with Completion Commit `cc4f22e5`. PERM-007-F / I244 Review/Claimed after local convergence; claim #465 merged at `94ba2dc5`, while exact-head CI and independent permission/security/API review remain pending. | `docs/backlog/active/PERM-007-F0-shell-auto-classifier-decision.md`; `docs/backlog/active/PERM-007-F-generic-shell-effect-classification.md`; `docs/iterations/I243-perm007f-shell-auto-classifier-decision.md`; `docs/iterations/I244-perm007f-shell-auto-classifier-implementation.md`; `docs/decisions/070-shell-auto-classifier-context.md`; Issue #462 |
