...
| 0 | Permission pipeline convergence | I189/PERM-006-A is Review/Claimed at implementation commit `6b577d6a` through PR #356, pending exact-head CI, independent security/code review and CAS. PERM-007-A/I218 is Complete at Completion Commit `a289a07f`; later `/auto` behavior remains blocked on PERM-006-A/B/C and separate child claims. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; `docs/backlog/active/PERM-007-A-auto-permission-security-decision.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/decisions/064-bounded-model-assisted-auto-permission.md`; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
