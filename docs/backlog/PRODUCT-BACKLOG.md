...
| 0 | Ordered mainline priority requirements | I211 is Complete/Closed through PR #331 and #335. T10 reassessed Issue #59 as Blocked because RUNTIME-005 and PERM-006-C are incomplete; RUNTIME-005-A/I214 is Active/Claimed after #336 merge `7de582a3`, decision-only. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211; I214 |
...
| 0 | Local convergence and stable-stage validation | GOV-008 / I215 is proposed Active/Claimed through one atomic governance PR, ineffective until merge. It implements I205's selected simplification plus the maintainer's local-convergence correction; no product/runtime scope. | `docs/backlog/active/GOV-008-local-convergence-stage-validation.md`; `docs/iterations/I215-local-convergence-stage-validation.md`; Issue #339 |
...
| 1 | Runtime session and protocol foundations | SESSION-008 is Complete. RUNTIME-005 remains Refinement/Unclaimed; A/I214 is Active/Claimed for its decision-only matrix and ADR after #336 merge `7de582a3`, B awaits A Accepted, and C awaits B. Issues #45/#49 remain open. | `docs/backlog/active/SESSION-008-interrupted-turn-partial-persistence.md`; `docs/iterations/I193-session008b-durable-partial-finalization.md`; `docs/decisions/058-partial-turn-durable-finalization.md`; `docs/reference/I187-SESSION-008-PARTIAL-TURN-CHARACTERIZATION.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/iterations/I214-runtime005a-shutdown-contract-decision.md` |
...
| 1 | Supervised background command jobs | I188/TOOL-024-A and TOOL-023-C are Complete. Production B remains blocked pending RUNTIME-005 and PERM-006-C; RUNTIME-005-A/I214 is Active only for the decision slice, and Windows remains fail-closed pending D. Issue #59 stays open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/iterations/I214-runtime005a-shutdown-contract-decision.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
...
| GOV-008 / I215 | Active / Claimed only when atomic governance PR merges | Implement local convergence, stable-stage remote validation and scenario fixtures while preserving protected/release/exact-head/CAS gates. [Story](active/GOV-008-local-convergence-stage-validation.md) / [Iteration](../iterations/I215-local-convergence-stage-validation.md) / Issue #339 |
