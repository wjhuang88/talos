...
| 0 | Permission pipeline convergence | A/I189 is Complete/Closed at `6b577d6a`; ADR-066 is Accepted through PR #358 merge `17e0b648`. I219/PERM-006-B is Review/Claimed in PR #368; its first head passed Unix/review but exposed a Windows test-only canonical-path expectation now corrected locally at `d0c96048`. Fresh exact-head CI/review/CAS remain and its permission/grant/store/API authority stays exclusive. C-E, later `/auto` behavior and TOOL-024 remain blocked. I213 is independently Active/Claimed and gains no PERM-006 authority. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-B-scoped-grant-store.md`; `docs/iterations/I219-perm006b-first-class-scoped-grants.md`; `docs/decisions/066-first-class-scoped-permission-grants.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md` |
...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is Active/Claimed through activation PR #363 merge `e578f419`, under the maintainer-approved I219/I213 non-overlap exception. It is GET/read-only observation only and cannot modify permission/runtime authority. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
|---|---|---|
| I219 / PERM-006-B | Review / Claimed | PR #368 first head passed Unix/review but exposed a Windows test-only path expectation; local correction `d0c96048` awaits next stable push and fresh exact-head CI/review/CAS. Exclusive permission/grant/store/API authority remains with I219. |
| I213 / WEB-001-B | Active / Claimed | Activation PR #363 merged as `e578f419`; implementation is authorized only under the I219 file/authority/CAS protection contract. |
