...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is In Progress / Active / Claimed through PR #276 merge `33b11433`. Exact-main evidence points to TUI input starvation before `UserInput::Cancel`; the bounded slice preserves NET-001, I200 and I206 exclusions. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; NET-001; I166; I200; I206; Issue #272 |
