...
| 1 | Dashboard availability in Logo prefix | TUI-037 / I202 is Ready / proposed claim pending. Implement and close Issue #104 before the mainline long task: one display-only token-free plain-text Logo row, no successful generic Tip, no bearer-token log, failure Tip preserved. No OSC 8, Dashboard product page, auth/bind or persistence change. | `docs/backlog/active/TUI-037-dashboard-logo-link.md`; `docs/iterations/I202-tui037-dashboard-logo-link.md`; ADR-031; ADR-054; Issue #104 |
