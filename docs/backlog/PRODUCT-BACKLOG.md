...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is Review/Claimed in PR #372, locally rebased onto `main@7fd813e8`. Refreshed exact-head CI/security review/CAS remain pending. Authorization `5386904546` permits only the non-overlapping I213/I222-B pair. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
| I213 / WEB-001-B | Review / Claimed | PR #372 is based on latest `main@7fd813e8`; refreshed exact-head CI, independent security review and merge-time CAS remain pending. I222-B's merged amendment remains outside all I213 files/authority. |
