...
| SKILL-005 / I232 | Planned / Unclaimed | Issue #333 owns real-CLI visibility of invalid local Skill `triggers` diagnostics; claim preparation only, ineffective until merge. [Owner](active/SKILL-005-invalid-skill-diagnostic-visibility.md) / [Iteration](../iterations/I232-skill005-invalid-diagnostic-visibility.md) |
