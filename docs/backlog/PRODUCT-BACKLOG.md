...
| 0 | TUI Native Selection And Copy | TUI-046-A/I184 is Complete with application-owned selection selected; TUI-046-B is ready for a separate implementation claim. Cross-platform terminal testing is a B merge-acceptance gate, not a development prerequisite. | `docs/backlog/active/TUI-046-native-text-selection-copy.md`; `docs/iterations/I184-tui-046a-selection-policy.md`; ADR-054; `docs/reference/TUI-NATIVE-SELECTION-MATRIX.md` |
...
| ARCH-034-R04 / I181 / I182 / I183 | Partial / I183 Complete | Review-only matrix completed at `aea26ad0`; [AG-4](active/ARCH-034-R04-AG4-symbol-traversal-containment.md) completed at `ae31242bdac4807599146bfb4847bcac52712bbf`. [AG-7](active/ARCH-034-R04-AG7-sqlite-adr-reconciliation.md) / [I183](../iterations/I183-sqlite-adr-reconciliation.md) completed at `edf903aa96574043294923ad60b0cefe9730f8c4`; AG-1/2/3/5/6/8/9/10 and residuals AG-11/12 remain unclaimed. |
...
| ARCH-034-R04-AG12 | Refinement — unclaimed SQLite validator-integrity residual | [AG-12](active/ARCH-034-R04-AG12-sqlite-validator-integrity.md) owns ADR-to-allowlist linkage, governance host-dependency policy and localized stderr diagnostic preservation; no consumer or runtime change is authorized. |
...
also waits for PERM-006-C. Issue #134 remains open under P0 TUI-046 Active; TUI-046-A is Complete
and TUI-046-B is ready for a separate claim. Cross-platform real-terminal testing occurs after
implementation and before B acceptance.
