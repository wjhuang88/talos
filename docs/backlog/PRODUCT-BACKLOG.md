...
|---|---|---|---|
| 0 | v0.8.0 GitHub-first crates publication | ARCH-031-A is Ready and I159 is Planned with proposed claim PR #235. Execute I159-I162 in their published order, then I203/REL-003 releases GitHub v0.8.0 before any Cargo publication. The intended closure is 20 packages excluding only `talos-models`; I162 must produce the exact GO packet. | `docs/tasks/2026-08-14-v080-github-first-crates-publication.md`; `docs/backlog/active/ARCH-031-crate-publication-boundary.md`; `docs/iterations/I159-talos-tools-feature-boundary.md`; `docs/iterations/I162-v0.6-sdk-publication-readiness.md`; `docs/backlog/active/REL-003-v080-github-and-crates-publication.md`; `docs/iterations/I203-v080-github-and-crates-publication.md` |
...
|---|---|---|
| ARCH-031-A / I159 | Ready / proposed claim PR #235 | Merge finalized PR #235 to `main` before creating its implementation branch; I160-I162 remain blocked in order. |
