...
|---|---|---|---|
| 0 | v0.9.0 GitHub-first crates publication | REL-005 / I245 proposed Active/Claimed; ineffective until its finalized governance PR merges. Prepare one locally converged candidate, complete GitHub Release first, then publish the Cargo closure and verify external CLI/runtime consumption. | `docs/tasks/2026-09-03-v090-github-first-crates-publication.md`; `docs/backlog/active/REL-005-v090-github-and-crates-publication.md`; `docs/iterations/I245-v090-github-and-crates-publication.md`; release SOPs; ARCH-031 publication matrix |
...
| 1 | Steering follow-up sequence | TUI-048/I206 Complete/Closed through PR #411 merge `9d7c87cb` (implementation head `c742eea5`), exact-head CI `33063880465` attempt 2 and independent approval `5438243363`. TUI-049/I207 and TUI-050/I208 remain Planned/Unclaimed. | `docs/tasks/2026-08-17-steering-follow-up-sequence.md`; `docs/backlog/active/TUI-048-steering-esc-activation.md`; `docs/iterations/I206-tui048-steering-esc-activation.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; Issues #267/#408 |
