...
| 0 | Change-aware CI routing | I190/GOV-005 is in Review at PR #202 after claim merge `bb38c262`: the fail-closed classifier must pass exact-head full CI and a post-merge prose-only probe before closure. | `docs/backlog/active/GOV-005-change-aware-ci-routing.md`; `docs/iterations/I190-change-aware-ci-routing.md` |
