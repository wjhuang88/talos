...
|---|---|---|---|
| 0 | v0.9.0 GitHub-first crates publication | REL-005 / I245 Review/Claimed after local versioned preflight. Exact-head CI and independent release review are pending; GitHub Release must complete before Cargo publication and external CLI/runtime acceptance. | `docs/tasks/2026-09-03-v090-github-first-crates-publication.md`; `docs/backlog/active/REL-005-v090-github-and-crates-publication.md`; `docs/iterations/I245-v090-github-and-crates-publication.md`; release SOPs; ARCH-031 publication matrix |
