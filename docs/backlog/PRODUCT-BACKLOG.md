...
| TUI-043 / I201 | Review / Claimed | Implementation commits `68f4fb7b`/`d1fef291` are in PR #309 Review; preserve legitimate assistant text and ordered tool rows until exact-head and deferred validation gates finish. |
