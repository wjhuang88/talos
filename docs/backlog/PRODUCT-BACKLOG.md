...
| I222 / TOOL-024-B managed background core | Active / Claimed proposed by #379; ineffective until merge | Bounded parallel pair with I213 under `5386904546`; Unix-only core with no CLI/Dashboard/Windows process spawn. |
