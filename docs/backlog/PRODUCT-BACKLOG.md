...
| 0 | Permission pipeline convergence | A/I189 and B/I219 are Complete/Closed. C stays Blocked/Unclaimed pending ADR-067 acceptance. I220 is Active/Claimed effective through #370 merge `5b8b1488` for decision-only work under the explicit I213/I220 non-overlap authorization; I221 later owns implementation. C-E, `/auto` behavior and TOOL-024 remain unauthorized. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md`; `docs/iterations/I220-perm006c-agent-owned-pipeline-decision.md`; `docs/decisions/065-structured-permission-rule-provenance.md`; `docs/iterations/I219-perm006b-first-class-scoped-grants.md` |
...
| I220 / PERM-006-C decision prerequisite | Active / Claimed effective through #370 merge `5b8b1488` | A/B complete. Decision-only ADR-067/current-path/migration work is effective in parallel with I213 under explicit non-overlap. ADR-067 acceptance and I221 remain separate gates; no C implementation authority. |
