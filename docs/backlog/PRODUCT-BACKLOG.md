...
| ARCH-034-R05..R11 | Ready | Separately claim one coherent behavior-preserving seam at a time after I171 evidence and dependency checks. |
| ARCH-034-R03 / I173 | In Progress / Active | Claim #148 is effective at `e9836ddf`; decompose Todo model/repository/formatting/tool adapters while preserving public paths, SQL, schemas, permissions, contribution order, and output. |
