...
| 0 | Ordered mainline priority requirements | Coordination claim and Deferred Human Validation Mode are effective. I200/I197/I201/I212 remain Review for Issue #302/I211. I210 PR #323 merged as `9d5c8a71` after exact-head CI/review/CAS and remains Review for its deferred human row; I198 is the next separately claimed child. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211 |
| 0 | Deferred human review and acceptance batch | VALIDATION-002 / I211 remains Planned / Unclaimed from Issue #302. PR #303 merged as `99645e78`, enabling the scheduling mode; the batch remains evidence-only and is not activated until ordered implementation dispositions are terminal. | `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md`; `docs/iterations/I211-deferred-human-validation-batch.md`; Issue #302 |
...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is Complete/Closed at Completion Commit `2eff6285`, with source implementation `7b82fea6`/`7d90def8`, exact-head CI `32025371877`, real-terminal acceptance and independent agent audit `5316533941`. The separate PROVIDER-006/I210 retry-progress owner is now Active/Claimed through `e58fbd39`. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; Issue #272; PR #279 |
| 1 | Bounded provider retry progress contract | PROVIDER-006 / I210 is Review/Claimed with implementation evidence `6efee2b8`; PR #323 final head `c984ec48` passed CI/review/CAS and merged as `9d5c8a71`. ADR-062 is Accepted; only the Issue #302 natural-person row remains open. | `docs/backlog/active/PROVIDER-006-bounded-retry-progress-contract.md`; `docs/iterations/I210-provider-retry-progress-contract.md`; `docs/decisions/062-typed-provider-retry-progress.md`; Issue #278; PR #323 |
...
| 0 | Permission pipeline convergence | I189/PERM-006-A is Planned/Claimed through claim merge `0df88638`; no implementation has started. B-E remain blocked in order. PERM-007 remains Refinement/Unclaimed for a proposed cross-surface default-on `auto` mode; ADR-011 revision and security decomposition are required before Ready. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; PERM-006-B/C/D/E; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
...
| 1 | TUI regression intake | TUI-041/#69 and I199 are Complete/Closed. I200 and I197 remain Review with human rows tracked by VALIDATION-002/I211/#302. TUI-043/#111 PR #309 head `d8d414ce` passed exact-head CI, Agent review and CAS, then merged as `7f5a6df2`; human suppression-safety validation and Completion Commit remain open. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/iterations/I199-tui041-thinking-preview-wrap-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md` |
...
| 1 | Custom-model context-window catalog inference | MODEL-013/I212 is Review/Claimed after implementation PR #318 merged as `5a1709cb`; exact-head CI `32319297491`, Agent approval `5349952979` and CAS passed. The natural-person custom-provider walkthrough remains in #302/I211. | `docs/backlog/active/MODEL-013-catalog-context-window-inference.md`; `docs/iterations/I212-model013-catalog-context-window-inference.md`; `docs/backlog/active/MODEL-011-custom-model-capability-probe.md`; ADR-022 |
...
| 1 | Supervised background command jobs | I188/TOOL-024-A is Complete at `245eddeb`; ADR-060 is Accepted after exact-head CI `31995198205`, independent security review `5312482823` and PR #228 merge `1db1211e`. Production B remains blocked pending completion of RUNTIME-005 and PERM-006-C; Windows remains fail-closed pending D. Issue #59 stays open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
...
| SKILL-004 | Review / Claimed — I198 implementation prepared | Optional `SKILL.md` triggers compatibility implements the additive missing-field default with compatibility fixtures, binary runtime evidence and bilingual docs; exact-head PR gates and Issue #302 human validation remain open. [Owner](active/SKILL-004-optional-skill-triggers-compatibility.md) |
