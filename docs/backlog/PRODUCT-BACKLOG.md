...
| ARCH-034-R11 / I180 | Planned / claimed in PR #170 | Documentation-truth reconciliation selected; implementation is not authorized until the finalized governance claim merges to `main`. |
