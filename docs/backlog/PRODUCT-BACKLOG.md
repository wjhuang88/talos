...
| ARCH-034-R04 / I181 / I182 | Partial / I181 review Complete / I182 Review | Review-only matrix completed at `aea26ad0`; [ARCH-034-R04-AG4](active/ARCH-034-R04-AG4-symbol-traversal-containment.md) implementation is in PR #177 at checkpoint `82684a2b`, pending exact-head CI and independent security review. Other gaps remain separately unowned. |
