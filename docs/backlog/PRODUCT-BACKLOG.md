...
| ARCH-034-R05 / I174 | Ready / Claim PR #151 | Proposed TUI input, stream/output, and frame-coordination source split; claim is ineffective and implementation prohibited until PR #151 merges. |
