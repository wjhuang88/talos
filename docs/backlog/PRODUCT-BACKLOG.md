...
remain incomplete. I285 Active / Claimed is proposed by governance PR #608 and remains ineffective
until merge.
...
| 1 | Desktop week 4: integrated acceptance | DESKTOP-001-D7 / I285 Active / Claimed proposed by #608, ineffective until merge; consolidate required #29 rows and candidate evidence | [D7](active/DESKTOP-001-D7-desktop-integrated-acceptance.md); [I285](../iterations/I285-desktop-integrated-acceptance.md); [task](../tasks/2026-09-22-desktop-four-week-delivery.md) |
...
| 1 | Pre-Provider rejection terminalization / #499 | RUNTIME-007 / I251 Complete / Closed. Runtime implementation is strictly limited to deterministic pre-Provider rejection lifecycle and model-switch unblocking; #408 remains related residual review. | `docs/backlog/active/RUNTIME-007-preprovider-rejection-terminalization.md`; `docs/iterations/I251-runtime007-preprovider-terminalization.md`; Issue #499 |
| 2 | Dependency risk evidence residuals / #502 | DEPENDENCY-003 is Refinement/Unclaimed and owns the post-I250 `libc` migration plus advisory/deprecation evidence gaps. Revisit by 2026-12-07 or the next workspace dependency upgrade; no implementation authority exists. | `docs/backlog/active/DEPENDENCY-003-dependency-risk-evidence-residuals.md`; ARCH-034-R04; DEPENDENCY-001; Issue #502 |
| 0 | v0.9.0 GitHub-first crates publication | REL-005 / I245 Complete/Closed at Completion Commit `fad6e24e`; GitHub Release workflow `33825995467`, 20 crates.io packages and external CLI/runtime acceptance passed. `talos-models` remains unpublished. | `docs/tasks/2026-09-03-v090-github-first-crates-publication.md`; `docs/backlog/active/REL-005-v090-github-and-crates-publication.md`; `docs/iterations/I245-v090-github-and-crates-publication.md`; release SOPs; ARCH-031 publication matrix |
...
| 0 | Goal-oriented work and evaluation foundation | Complete / Closed — P0/I196 through P4/I240. P4 Completion Commit `29fb900e`; PR #451 merged as `2d667085`; final exact-head CI `33412796197` and independent Agent-role review `5481320406` passed. | `docs/backlog/active/WORK-001-goal-oriented-work-evaluation-foundation.md`; `docs/backlog/active/WORK-001-E-mission-gate-ui-neutral-projection.md`; `docs/backlog/active/WORK-001-B-work-domain-and-todo-compatibility.md`; `docs/backlog/active/WORK-001-C-completion-claim-evaluation-state.md`; `docs/backlog/active/WORK-001-D-independent-evaluator-runtime.md`; `docs/iterations/I237-work-domain-and-todo-compatibility.md`; `docs/iterations/I238-completion-claim-evaluation-state.md`; `docs/iterations/I239-independent-evaluator-runtime.md`; `docs/iterations/I240-work001-e-mission-gate-projection.md`; `docs/decisions/061-canonical-work-domain-and-todo-migration.md`; DESKTOP-001; RUNTIME-001; SESSION-009; VALIDATION-001 |
| 0 | Ordered mainline priority requirements | Complete/Closed with owned residuals. T1-T10 have terminal dispositions and T11 is Complete; #59 remains Blocked only on separate TOOL-024 authority. I197/I198/I201/I210 are closed after corrective implementations and human validation. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211; I214; I216; I217 |
...
| 1 | Automatic protocol and bounded model decisions | Complete / Closed: automatic selection, model-assisted recovery and shared bounded invocation merged and audited. | `docs/backlog/active/PROMPT-001-prompt-authority-architecture.md`; Issue #285; I273; ADR-075 |
| 1 | I273 bounded model decisions | Complete / Closed; implementations #559/#562 merged and owner closeout recorded. | `docs/iterations/I273-bounded-model-decisions.md`; ADR-075; Issue #285 |
| 1 | Evolution learned-pattern authority | PROMPT-001 child I269 Complete / Closed at `90970607`; cross-module behavior harness remains separate. | `docs/iterations/I269-evolution-prompt-authority.md`; Issue #285 |
...
| 1 | Tombstone-pruning fixture performance | TEST-002 / I227 Complete / Closed at Completion Commit `7b64a08b`; PR #399 merged as `d02915e0` after exact-head CI `32839820741` and independent approval `5409698923`. Production retention and behavior unchanged. | `docs/backlog/active/TEST-002-tombstone-pruning-fixture-performance.md`; `docs/iterations/I227-test002-tombstone-pruning-fixture-performance.md`; `docs/sop/TESTING.md`; pending-submission storage/tests; Windows CI |
...
| 1 | Shared text semantics | TEXT-001 / I256 / #511 is Complete/Closed; Completion Commit `a1a215e0`, PR #531, CI `34476929013`, independent approval `5618698607`. | `docs/backlog/active/TEXT-001-ui-neutral-text-semantics.md`; `docs/iterations/I256-ui-neutral-text-semantics.md`; ADR-072 |
| 1 | Progressive capability provider architecture | CAP-001 / #466 Complete / Closed: architecture governance and child decomposition complete; LANG-003, DIST-001-B and BROWSER-001 are closed by #565/#567/#569. | `docs/backlog/active/CAP-001-progressive-capability-provider-architecture.md`; ADR-072; child owners |
| 2 | OBeiBuddy upstream contract clarification | INTEGRATION-001 / I262 Complete / Closed. Completion Commit `86a7ef76`; Request B Deferred, no implementation authority. | `docs/backlog/active/INTEGRATION-001-obeibuddy-upstream-contract-clarification.md`; ADR-063; WEB-007; BROWSER-001; WEB-005; TOOL-014; Issue #520 |
...
| 1 | Bounded provider retry progress contract | PROVIDER-006 / I210 is Complete/Closed at `9d5c8a71` with live retry-status validation. I231/TUI-060/#332 is Complete/Closed at `e4cbb714`, correcting fleeting initial connection status and false idle-first-turn queue messaging. | `docs/backlog/active/PROVIDER-006-bounded-retry-progress-contract.md`; `docs/iterations/I210-provider-retry-progress-contract.md`; `docs/backlog/active/TUI-060-initial-connection-and-queue-status-sequencing.md`; `docs/iterations/I231-tui060-connection-queue-sequencing.md`; Issues #278/#332 |
...
| 1 | Model-assisted auto permission decisions | PERM-007-A/I218, B/I233, C/I234 and D/I236 are Complete/Closed. I234 Completion Commit `7ddba098`; I236 Completion Commit `5cb6ddc`; Issue #188 is closed. | `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md`; `docs/backlog/active/PERM-007-B-auto-config-session-command.md`; `docs/backlog/active/PERM-007-C-model-assisted-resolver.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/iterations/I233-perm007b-auto-config-session-command.md`; `docs/iterations/I234-perm007c-model-assisted-resolver.md`; `docs/iterations/I236-perm007d-cross-surface-conformance.md`; ADR-064; Issue #188 |
| 0 | Model-first permission triage follow-up | PERM-007-E / I241 Complete / Closed through PR #460 merge `b7735ef8`; exact-head CI `33475638936` and independent review `5489739524` passed. | `docs/backlog/active/PERM-007-E-model-first-permission-triage.md`; `docs/iterations/I241-perm007e-model-first-permission-triage.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
| 0 | Generic shell auto classifier | PERM-007-F0 / I243 and PERM-007-F / I244 Complete/Closed; ADR-070 Accepted. I244 completion commits `4342caa6`, `63358c8a`, and `6bcc8eca`; corrective PR #473 merged as `11c6dc28` after CI, independent security review, real-TUI acceptance, and CAS. | `docs/backlog/active/PERM-007-F0-shell-auto-classifier-decision.md`; `docs/backlog/active/PERM-007-F-generic-shell-effect-classification.md`; `docs/iterations/I243-perm007f-shell-auto-classifier-decision.md`; `docs/iterations/I244-perm007f-shell-auto-classifier-implementation.md`; `docs/decisions/070-shell-auto-classifier-context.md`; Issue #462 |
| 0 | PERM-007-E security decision | I242 Complete / Closed; ADR-069 accepted with decision-only evidence. | `docs/iterations/I242-perm007e-security-decision.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
| 1 | PERM-007-C capability decision | I235 Complete / Closed; decision-only Completion Commit `71acbe0c`. I234 and I236 later completed the implementation/conformance chain. | `docs/backlog/active/PERM-007-C0-atomic-create-capability-decision.md`; `docs/iterations/I235-perm007c-atomic-create-capability-decision.md`; ADR-064; Issue #188 |
...
| 1 | TUI regression intake | TUI-041/I199, TUI-042/I200, TUI-043/I201, TUI-045/I197, I229/TUI-058/#329 and I230/TUI-059/#330 are Complete/Closed. TUI-061/#334 separately owns continuation padding. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/backlog/active/TUI-058-permission-mediated-tool-activity-correlation.md`; `docs/iterations/I229-tui058-permission-tool-correlation.md`; `docs/backlog/active/TUI-059-permission-prompt-composer-docking.md`; `docs/iterations/I230-tui059-permission-prompt-docking.md`; `docs/backlog/active/TUI-061-history-continuation-padding-regression.md`; `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md` |
| 1 | Steering and capability seam serial plan | I207/TUI-049 Complete / Closed; I208/TUI-050 Complete / Closed; I246/CAP-001-P0 Complete / Closed at Completion Commit `9a3c1d86` via PR #492. | `docs/tasks/2026-09-04-steering-and-capability-seam-serial-plan.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/iterations/I207-tui049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; `docs/iterations/I208-tui050-steering-insertion-boundary.md`; `docs/backlog/active/CAP-001-P0-progressive-capability-compatibility-preparation.md`; `docs/iterations/I246-cap001-p0-compatibility-preparation.md`; Issues #267/#467 |
| 1 | Remaining TUI interaction intake | TUI-053/#268 is Complete: implementation 1647f9d8, numeric isolation tests and maintainer-confirmed Chinese IME acceptance; historical claim gap remains disclosed in its owner. TUI-052/#266, TUI-054/#269 and TUI-055/#280 remain Intake / Unclaimed; TUI-056/#298 and TUI-057/#310 join TUI-061/#334 in I279: Complete/Closed through #580 merge 52276f55; native acceptance, CI and independent review passed. Remaining intake is unselected. TUI-051/#272 is Complete through I209. | `docs/backlog/active/TUI-052-todo-rendering-muted-readability.md`; `docs/backlog/active/TUI-053-numeric-permission-shortcuts.md`; `docs/backlog/active/TUI-054-native-key-repeat-routing.md`; `docs/backlog/active/TUI-055-narrow-markdown-table-layout.md`; `docs/backlog/active/TUI-056-collapsible-reasoning-history.md`; `docs/backlog/active/TUI-057-live-activity-status-headers.md`; `docs/backlog/active/TUI-051-resumed-session-interactivity.md` |
...
| 1 | Runtime single-direct-dependency SDK facade | RUNTIME-006 / I280 / #234 Complete / Closed at implementation merge 007ca29d; owner closeout ade0b68c; no release. | `docs/backlog/active/RUNTIME-006-single-dependency-sdk-facade.md`; `docs/iterations/I280-runtime006-single-dependency-sdk.md`; `docs/reference/RUNTIME-SDK-CONTRACT.md`; ARCH-031; ADR-024; ADR-052; Issue #234 |
| 1 | Supervised background command jobs | TOOL-024-B through D2 and I223 are Complete/Closed. All V59-B1/C1/D1/D2/FINAL rows passed, including Windows device run `32958236636`; evidence merge `00bf2d5d` and I223 Completion Commit `a5fbc22e` are recorded. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md`; Issue #378 |
...
| I223 / Issue #59 deferred validation cleanup | Complete / Closed | Completion Commit `a5fbc22e`; all V59-B1/C1/D1/D2/FINAL evidence passed, including Windows device run `32958236636`. No product behavior authority. |
...
| TUI-043 / I201 | Complete / Closed | Implementation merged as `7f5a6df2`; I229/TUI-058 correction and 2026-08-28 natural-person approval, denial and cancel validation are complete. |
...
| MODEL-007 follow-up | Deferred behind Desktop / Refinement / Unclaimed | 2026-09-22 Desktop scheduling supersedes the prior next-item order. Preserve verified provider/model reasoning-effort choices, catalog updates and picker-to-request requirements; not activated or cancelled. [Owner](active/MODEL-007-hierarchical-model-variant-selection.md#2026-09-22-scheduling-update) |
...
| SKILL-004 / I198 | Complete / Closed | Completion Commits `f719ed91`/`fedd6fac`; omitted/empty/list compatibility and explicit malformed-input diagnostics are complete, with invalid discovery remaining fail-closed. [Owner](active/SKILL-004-optional-skill-triggers-compatibility.md) |
| SKILL-005 / I232 | Complete / Closed | Issue #333 closed through implementation merge `fedd6fac` (source `fb47b0c2`), exact-head CI `33141878176`, and independent review `5448628671`; invalid local Skill `triggers` diagnostics are visible only on explicit activation while discovery remains fail-closed. [Owner](active/SKILL-005-invalid-skill-diagnostic-visibility.md) / [Iteration](../iterations/I232-skill005-invalid-diagnostic-visibility.md) |
| TUI-061 | I279 Complete / Closed | Issue #334 owns ordinary wrapped-history continuation padding; delivered through #580 merge 52276f55; native acceptance and all gates passed. [Owner](active/TUI-061-history-continuation-padding-regression.md) |
