...
| 1 | TUI regression intake | TUI-041/#69 and I199 are Complete/Closed. TUI-042/#79 and I200 are Review/Claimed through implementation PR #301; exact-head and human acceptance gates remain open. TUI-045/#125 and TUI-043/#111 remain Planned/Unclaimed through I197/I201. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/iterations/I199-tui041-thinking-preview-wrap-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md` |
