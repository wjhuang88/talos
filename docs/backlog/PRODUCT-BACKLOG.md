...
| 1 | Bounded provider retry progress contract | PROVIDER-006 / I210 is Planned / Unclaimed from Issue #278 and ordered after I212. Initial dispatch shows `Connecting…`; actual retry/timeout facts drive `Reconnecting… (attempt n/m)`. ADR and effective claim remain mandatory. | `docs/backlog/active/PROVIDER-006-bounded-retry-progress-contract.md`; `docs/iterations/I210-provider-retry-progress-contract.md`; Issue #278 |
