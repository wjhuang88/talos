...
| 1 | Supervised background command jobs | TOOL-024-B/I222 is Complete/Closed; TOOL-024-C/I224 is Active/Claimed through #385 (ineffective until merge); D and I223 remain ordered residuals, and Windows remains fail-closed. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-B-managed-background-execution-core.md`; `docs/backlog/active/TOOL-024-C-model-readable-process-job-control.md`; `docs/iterations/I222-tool024b-managed-background-execution-core.md`; `docs/iterations/I224-tool024c-model-readable-process-job-control.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md` |
