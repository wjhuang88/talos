...
| 0 | Goal-oriented work and evaluation foundation | WORK-001-A / I196 P0 is Complete / Closed through Completion Commit `779a4c71` and PR #291 merge `1467a561`; WORK-001-B/P1 has proposed I237 owner/claim, ineffective until governance merge. P2-P4 remain separately blocked and unactivated. | `docs/backlog/active/WORK-001-goal-oriented-work-evaluation-foundation.md`; `docs/backlog/active/WORK-001-A-work-domain-decision-migration-contract.md`; `docs/backlog/active/WORK-001-B-work-domain-and-todo-compatibility.md`; `docs/iterations/I196-work-domain-decision-migration-contract.md`; `docs/iterations/I237-work-domain-and-todo-compatibility.md`; DESKTOP-001; RUNTIME-001; SESSION-009; TODO-001; TODO-002; VALIDATION-001 |
