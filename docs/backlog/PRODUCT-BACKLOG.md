...
| 0 | Emergency terminal containment | I191/TOOL-026 is Review at implementations `d6d298a4` and `6bbcb568`; preflight passed, while independent exact-head security review, CI and merge remain required. | `docs/backlog/active/TOOL-026-noninteractive-terminal-containment.md`; `docs/iterations/I191-noninteractive-terminal-containment.md`; ADR-007 |
| 0 | Emergency Session recovery closure | I192/SESSION-010 is Review at implementations `ecd615a0`, `c597c0bb`, `d98f6d0a`; review `5265172266` exposed and the correction closes parser-authorized deletion. Exact-head re-review/CI/merge remain pending; no automatic historical/forced-kill cleanup is claimed. | `docs/backlog/active/SESSION-010-runtime-resume-empty-artifact-closure.md`; `docs/iterations/I192-session-runtime-recovery-closure.md` |
...
| 1 | Runtime session and protocol foundations | I187/SESSION-008-A is Complete at `e288afb5` and ADR-058 is Accepted by this reviewed closeout. SESSION-008-B is Ready/Unclaimed and must complete before RUNTIME-005-A/B/C; Issues #45/#49 remain open. | `docs/backlog/active/SESSION-008-interrupted-turn-partial-persistence.md`; `docs/iterations/I187-session008a-partial-turn-lifecycle.md`; `docs/decisions/058-partial-turn-durable-finalization.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md` |
...
| TOOL-026 / I191 | Review — emergency terminal containment | Non-interactive stdin and Unix controlling-terminal isolation implemented at `d6d298a4` + `6bbcb568`; review `5265172266` validated the real-PTY boundary, while exact-head re-review and merge remain pending. [Story](active/TOOL-026-noninteractive-terminal-containment.md) / [Iteration](../iterations/I191-noninteractive-terminal-containment.md) |
| SESSION-010 / I192 | Review — emergency runtime/session closure | Matching-target resume reuse, non-empty picker filtering and strict zero-byte no-chat cleanup implemented at `ecd615a0` + `c597c0bb` + `d98f6d0a`; ambiguous non-empty transcripts are preserved and forced-kill cleanup remains explicit. [Story](active/SESSION-010-runtime-resume-empty-artifact-closure.md) / [Iteration](../iterations/I192-session-runtime-recovery-closure.md) |
