...
| 1 | Steering follow-up sequence | TUI-048/I206 proposes Active/Claimed to absorb Issue #408 and implement Esc-cancelled steering activation plus provider-switch recovery after queue drain. TUI-049/I207 and TUI-050/I208 remain Planned/Unclaimed. No implementation authority before the I206 claim merges. | `docs/tasks/2026-08-17-steering-follow-up-sequence.md`; `docs/backlog/active/TUI-048-steering-esc-activation.md`; `docs/iterations/I206-tui048-steering-esc-activation.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; Issues #267/#408 |
