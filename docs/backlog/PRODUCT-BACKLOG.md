...
| 1 | Bounded provider retry progress contract | PROVIDER-006 / I210 is proposed Active / Claimed through governance PR #321; the proposal is ineffective while open. ADR-062 defines typed actual retry/timeout facts for `Connecting…` then `Reconnecting… (attempt n/m)` without policy changes. | `docs/backlog/active/PROVIDER-006-bounded-retry-progress-contract.md`; `docs/iterations/I210-provider-retry-progress-contract.md`; `docs/decisions/062-typed-provider-retry-progress.md`; Issue #278; PR #321 |
