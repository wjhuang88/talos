...
| 0 | PERM-007-E security decision | I242 is Active / Claimed; decision-only review and acceptance/rejection of ADR-069 before I241 implementation. | `docs/iterations/I242-perm007e-security-decision.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
