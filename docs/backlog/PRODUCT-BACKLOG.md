...
| 0 | Goal-oriented work and evaluation foundation | P0/I196 and P1/I237 are Complete / Closed. I237 Completion Commit `f2b0b5c7`; exact-head CI `33323509558` attempt 2 and independent review `5470154364` passed. P2 is next but requires its own owner, iteration and effective claim; P3-P4 remain separately blocked. | `docs/backlog/active/WORK-001-goal-oriented-work-evaluation-foundation.md`; `docs/backlog/active/WORK-001-A-work-domain-decision-migration-contract.md`; `docs/backlog/active/WORK-001-B-work-domain-and-todo-compatibility.md`; `docs/iterations/I196-work-domain-decision-migration-contract.md`; `docs/iterations/I237-work-domain-and-todo-compatibility.md`; DESKTOP-001; RUNTIME-001; SESSION-009; TODO-001; TODO-002; VALIDATION-001 |
