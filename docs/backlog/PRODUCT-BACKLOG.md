...
| 0 | Generic shell auto classifier | PERM-007-F0 / I243 is proposed Active/Claimed through governance PR #463, ineffective until merge; ADR-070 remains Proposed. PERM-007-F / I244 remains Blocked/Unclaimed pending the decision and authority reconciliation with Issues #56/#57. | `docs/backlog/active/PERM-007-F0-shell-auto-classifier-decision.md`; `docs/backlog/active/PERM-007-F-generic-shell-effect-classification.md`; `docs/iterations/I243-perm007f-shell-auto-classifier-decision.md`; `docs/iterations/I244-perm007f-shell-auto-classifier-implementation.md`; `docs/decisions/070-shell-auto-classifier-context.md`; Issue #462 |
