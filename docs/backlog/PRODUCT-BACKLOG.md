...
| ARCH-034-R08 / I177 | Planned / claim pending | Private agent Session custody/reconciliation decomposition selected; no implementation authority exists until the finalized governance claim merges to `main`. |
