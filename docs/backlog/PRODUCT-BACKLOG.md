...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is Review / Claimed. Implementation commits `7b82fea6`/`7d90def8` cache unchanged history and prove four cancellation boundaries; exact-head CI, real-terminal evidence and independent review remain open. Retry progress moved by change control to PROVIDER-006/I210. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; Issue #272 |
