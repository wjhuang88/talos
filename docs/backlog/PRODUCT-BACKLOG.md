...
| 0 | Ordered mainline priority requirements | Planned coordination record from #227; no child is activated by the long task. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I196; I188; I199; I200; I197; I201; I198 |
...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is Review / Claimed in PR #279. Implementation commits `7b82fea6`/`7d90def8` cache unchanged history and prove four cancellation boundaries; exact-head CI, real-terminal evidence and independent review remain open. Retry progress moved by change control to PROVIDER-006/I210. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; Issue #272; PR #279 |
...
| 1 | Remaining TUI interaction intake | TUI-052/#266, TUI-053/#268 and TUI-054/#269 remain Intake / Unclaimed with no selected iteration and require decomposition/overlap checks before selection. TUI-051/#272 is separately in Review as I209. | `docs/backlog/active/TUI-052-todo-rendering-muted-readability.md`; `docs/backlog/active/TUI-053-numeric-permission-shortcuts.md`; `docs/backlog/active/TUI-054-native-key-repeat-routing.md`; `docs/backlog/active/TUI-051-resumed-session-interactivity.md` |
