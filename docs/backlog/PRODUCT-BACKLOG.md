...
| 1 | Runtime session and protocol foundations | SESSION-008 is Complete. ADR-063 is Accepted and RUNTIME-005-A/I214 is Complete/Closed at `6719c876`; parent RUNTIME-005 and B are Ready/Unclaimed, while C remains Blocked on B. Issues #45/#49 remain open. | `docs/backlog/active/SESSION-008-interrupted-turn-partial-persistence.md`; `docs/iterations/I193-session008b-durable-partial-finalization.md`; `docs/decisions/058-partial-turn-durable-finalization.md`; `docs/reference/I187-SESSION-008-PARTIAL-TURN-CHARACTERIZATION.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/iterations/I214-runtime005a-shutdown-contract-decision.md` |
