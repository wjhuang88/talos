...
| 1 | Steering and capability seam serial plan | I207/TUI-049 Review / Claimed after implementation PR #483 merged as `ca3b2fa7`; closeout evidence remains pending. I208/TUI-050 and I246/CAP-001-P0 remain Planned / Unclaimed and execute serially afterward. | `docs/tasks/2026-09-04-steering-and-capability-seam-serial-plan.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/iterations/I207-tui049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; `docs/iterations/I208-tui050-steering-insertion-boundary.md`; `docs/backlog/active/CAP-001-P0-progressive-capability-compatibility-preparation.md`; `docs/iterations/I246-cap001-p0-compatibility-preparation.md`; Issues #267/#467 |
