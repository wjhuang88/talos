...
| 1 | Custom-model context-window catalog inference | MODEL-013 is Ready and I212 is Planned/Unclaimed in claim preparation for #312. Exact/one-prefix matching must select one catalog row, explicit config wins, and provenance is derived without migration; no network or capability inference. | `docs/backlog/active/MODEL-013-catalog-context-window-inference.md`; `docs/iterations/I212-model013-catalog-context-window-inference.md`; `docs/backlog/active/MODEL-011-custom-model-capability-probe.md`; ADR-022 |
