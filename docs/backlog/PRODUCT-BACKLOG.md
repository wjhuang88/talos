...
| 0 | Resumed Session interactivity under provider delay | TUI-051 / I209 is Ready / Planned / Unclaimed from Issue #272. After #271 disposition, reproduce the cancellation loss and deliver bounded retry status plus large-history projection invalidation before I205 and the existing long-task sequence. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/iterations/I209-resumed-session-interactivity.md`; NET-001; I166; I200; I206; Issue #272 |
