...
| ARCH-034-R04 / I181 | Partial / I181 review Complete | Review-only native/panic matrix completed at `aea26ad0`; accepted gaps remain unimplemented and require separate bounded owners/claims before native/unsafe/protected changes. |
