...
| 1 | Runtime session and protocol foundations | SESSION-008 is Complete. RUNTIME-005 remains Refinement/Unclaimed; A is Ready and selected as decision-only I214 Planned/Unclaimed, B awaits A Accepted, and C awaits B. Issues #45/#49 remain open. | `docs/backlog/active/SESSION-008-interrupted-turn-partial-persistence.md`; `docs/iterations/I193-session008b-durable-partial-finalization.md`; `docs/decisions/058-partial-turn-durable-finalization.md`; `docs/reference/I187-SESSION-008-PARTIAL-TURN-CHARACTERIZATION.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/iterations/I214-runtime005a-shutdown-contract-decision.md` |
...
| 1 | Supervised background command jobs | I188/TOOL-024-A and TOOL-023-C are Complete. Production B remains blocked pending RUNTIME-005 and PERM-006-C; RUNTIME-005-A/I214 is only a separate decision-gate preparation, and Windows remains fail-closed pending D. Issue #59 stays open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/iterations/I214-runtime005a-shutdown-contract-decision.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
