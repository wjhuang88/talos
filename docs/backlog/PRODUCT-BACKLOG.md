...
| ARCH-034-R04 / I181 / I182 | Partial / I181 review Complete / AG-4 claim proposed | Review-only matrix completed at `aea26ad0`; [ARCH-034-R04-AG4](active/ARCH-034-R04-AG4-symbol-traversal-containment.md) proposes only symbol symlink/depth/count/byte containment and requires independent claim review before implementation. Other gaps remain separately unowned. |
