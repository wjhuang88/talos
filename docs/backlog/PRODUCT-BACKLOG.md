...
| ARCH-034-R10 / I179 | Review | Claim PR #167 merged as `9a5419e4` after exact-head CI `31183822345`; private facade decomposition, public-path probes, locked workspace validation, and release preflight pass, with implementation PR creation pending. |
