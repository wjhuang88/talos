...
| 0 | Permission pipeline convergence | I189/PERM-006-A is Active from PR #351 merge `20cfcce4`. Decision-only PERM-007-A/I218 is Active from PR #352 merge `ca30081a`; Proposed ADR-064 requires exact-head security review, and later `/auto` behavior remains blocked on PERM-006-A/B/C and separate child claims. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; `docs/backlog/active/PERM-007-A-auto-permission-security-decision.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/decisions/064-bounded-model-assisted-auto-permission.md`; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
