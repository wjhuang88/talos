...
| 1 | Progressive capability provider architecture | CAP-001 / Issue #466 and preparatory CAP-001-P0 / Issue #467 are Refinement / Unclaimed / unselected. Intake defines architecture and compatibility-seam boundaries only; no code, Cargo, dependency, runtime or Desktop implementation is authorized. | `docs/backlog/active/CAP-001-progressive-capability-provider-architecture.md`; `docs/backlog/active/CAP-001-P0-progressive-capability-compatibility-preparation.md`; ADR-027; ADR-029; PLUGIN-001; TOOL-008; DIST-001; WEB-005 |
...
| 1 | Steering and capability seam serial plan | I207/TUI-049 proposes Complete / Closed after implementation PR #483 merge `ca3b2fa7` and native-terminal acceptance. I208/TUI-050 and I246/CAP-001-P0 remain Planned / Unclaimed and execute serially after the closeout reaches main. | `docs/tasks/2026-09-04-steering-and-capability-seam-serial-plan.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/iterations/I207-tui049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; `docs/iterations/I208-tui050-steering-insertion-boundary.md`; `docs/backlog/active/CAP-001-P0-progressive-capability-compatibility-preparation.md`; `docs/iterations/I246-cap001-p0-compatibility-preparation.md`; Issues #267/#467 |
