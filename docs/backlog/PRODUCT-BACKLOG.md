...
| ARCH-034-R05 / I174 | Ready / Planned claim proposal | Governance-only TUI input, stream/output, and frame-coordination source split; preserve public paths and all runtime/visual behavior. |
