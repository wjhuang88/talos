...
| 1 | Supervised background command jobs | I188/TOOL-024-A is Review in PR #228 through effective claim merge `02a35588` and implementation `245eddeb`. Proposed ADR-060 makes B an explicit Unix-first slice; independent exact-head review/CI/CAS gate acceptance. Production still waits for RUNTIME-005 and PERM-006-C; Windows remains fail-closed until D's separate Job Object gate. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/decisions/060-supervised-background-command-jobs.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
...
| TOOL-026 / I191 | Complete | Completion Commit `512ff32f389167364c02e7058151879b9ce6859a`; final head `6b2dbdb5`, CI `31587076213` and independent review `5274917099`. Active TOOL-024-A/I188 consumes the `setsid` evidence but does not reopen I191. [Story](active/TOOL-026-noninteractive-terminal-containment.md) / [Iteration](../iterations/I191-noninteractive-terminal-containment.md) |
