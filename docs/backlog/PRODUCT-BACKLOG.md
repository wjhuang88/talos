...
| 1 | Tombstone-pruning fixture performance | TEST-002 / Issue #396 is Ready / Unclaimed. Preserve permanent idempotency coverage and production retention limits while removing the Windows 60-second fixture delay. | `docs/backlog/active/TEST-002-tombstone-pruning-fixture-performance.md`; `docs/sop/TESTING.md`; pending-submission storage/tests; Windows CI |
