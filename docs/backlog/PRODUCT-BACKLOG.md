...
| 0 | Ordered mainline priority requirements | Planned long task with proposed coordination claim PR #227 now orders I196 → I188/#59 → I199/#69 → I200/#79 → I197/#125 → I201/#111 → I198/#155, then conditionally revisits #59 production slices. The claim is ineffective before `main`; every child remains separately claimed and reviewed. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I196-I201 |
...
| 1 | Dashboard read-only visual shell | WEB-001-A / I195 is Ready / proposed Claimed through governance PR #212; the claim remains ineffective until its finalized exact head passes validation, independent natural-person review, merge-time CAS, and reaches `main`. The slice is user-facing IA/UX over the existing GET-only loopback surfaces only; no write/control/remote/session-mutation capability. | `docs/backlog/active/WEB-001-A-dashboard-read-only-visual-shell.md`; `docs/iterations/I195-dashboard-read-only-visual-shell.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-031; three-track baseline |
| 1 | TUI regression sequence | TUI-041/#69, TUI-042/#79, TUI-045/#125 and TUI-043/#111 are Ready with I199 → I200 → I197 → I201 Planned/Unclaimed. The order reduces shared viewport/anchor churn but does not combine scopes or activate a child. | `docs/iterations/I199-tui041-thinking-preview-wrap-height.md`; `docs/iterations/I200-tui042-noop-history-scroll-stability.md`; `docs/iterations/I197-tui045-permission-prompt-anchor-stability.md`; `docs/iterations/I201-tui043-tool-placeholder-suppression.md` |
...
| TUI-041 / I199 | Ready / Planned / Unclaimed | After the #59 readiness disposition, establish a separate effective claim before implementing Issue #69. |
| TUI-042 / I200 | Ready / Planned / Unclaimed | Follow I199 disposition, then establish a separate effective claim before implementing Issue #79. |
| TUI-045 / I197 | Ready / Planned / Unclaimed | Follow the ordered long-task predecessor disposition, then establish a separate effective claim before implementing Issue #125. |
| TUI-043 / I201 | Ready / Planned / Unclaimed | Follow I197 disposition, then establish a separate effective claim for the bounded Issue #111 presentation fix. |
| SKILL-004 / I198 | Ready / Planned / Unclaimed | Follow I201 disposition, establish a separate effective claim, and confirm the omitted-`triggers` compatibility contract before parser edits. |
...
| SKILL-004 / I198 | Ready / Planned / Unclaimed — Issue #155 | Confirm the planned omitted-`triggers` compatibility contract, then add bounded parser fixtures and skill-author docs under a separate effective claim. [Owner](active/SKILL-004-optional-skill-triggers-compatibility.md) / [Iteration](../iterations/I198-skill004-optional-triggers-compatibility.md) |
