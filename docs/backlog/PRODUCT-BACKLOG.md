...
| 1 | Runtime session and protocol foundations | SESSION-008 and RUNTIME-005-A/I214 are Complete and ADR-063 is Accepted. RUNTIME-005-B/I216 is a Planned/Unclaimed governance-only claim proposal; it has no effect before merge. C remains Blocked on B and Issues #45/#49 remain open. | `docs/backlog/active/SESSION-008-interrupted-turn-partial-persistence.md`; `docs/iterations/I193-session008b-durable-partial-finalization.md`; `docs/decisions/058-partial-turn-durable-finalization.md`; `docs/reference/I187-SESSION-008-PARTIAL-TURN-CHARACTERIZATION.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/RUNTIME-005-A-shutdown-contract-decision.md`; `docs/backlog/active/RUNTIME-005-B-shutdown-coordinator-admission.md`; `docs/iterations/I216-runtime005b-shutdown-coordinator-admission.md` |
