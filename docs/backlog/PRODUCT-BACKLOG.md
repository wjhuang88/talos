...
| ARCH-034-R04 / I181 / I182 | Partial / I181 review Complete / I182 Complete | Review-only matrix completed at `aea26ad0`; [AG-4](active/ARCH-034-R04-AG4-symbol-traversal-containment.md) completed at `ae31242bdac4807599146bfb4847bcac52712bbf`. [AG-1](active/ARCH-034-R04-AG1-bash-pre-exec-hardening.md), [AG-2](active/ARCH-034-R04-AG2-parent-hardening-api.md), [AG-3](active/ARCH-034-R04-AG3-exec-timeout-pipe-containment.md), [AG-5](active/ARCH-034-R04-AG5-parser-panic-deadline.md), [AG-6](active/ARCH-034-R04-AG6-git-operation-containment.md) and [AG-7](active/ARCH-034-R04-AG7-sqlite-adr-reconciliation.md) are bounded but unclaimed owners. |
