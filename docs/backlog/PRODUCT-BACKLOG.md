...
| 1 | Desktop D0 renderer/host boundary | `DESKTOP-001-D0` / I194 Review after claim merge `f778543c`; upstream renderer evidence remains blocked by environment proxy failure. The parent DESKTOP-001 remains Deferred / Unclaimed / Selected Iteration None; D0 is decision-only and does not authorize GPUI, i18n, native dependencies or Desktop implementation. | `docs/backlog/active/DESKTOP-001-D0-renderer-host-boundary.md`; `docs/iterations/I194-desktop-renderer-host-boundary.md`; `docs/backlog/active/DESKTOP-001-desktop-product-direction.md`; ADR-042; ADR-052; ADR-059; `docs/reference/DESKTOP-I194-DEPENDENCY-SECURITY-MATRIX.md` |
