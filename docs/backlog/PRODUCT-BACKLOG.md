...
| 0 | Permission pipeline convergence | PR #351 merged as `20cfcce4`; I189/PERM-006-A is Active/Claimed. PR #352 proposes atomic Active/Claimed state for decision-only PERM-007-A/I218, ineffective before merge; later `/auto` behavior remains blocked on PERM-006-A/B/C and separate child claims. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-A-structured-permission-decisions.md`; `docs/iterations/I189-perm006a-structured-permission-decisions.md`; `docs/backlog/active/PERM-007-A-auto-permission-security-decision.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md` |
