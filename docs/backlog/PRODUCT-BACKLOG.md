...
| I222 / TOOL-024-B managed background core | Review / Claimed; local stable candidate, implementation PR not started | PR #379 merged as `48e8ae9b`; local focused locked checks pass from `main@7fd813e8`. Full preflight, fresh exact-head CI, independent process/permission/unsafe/API review and CAS remain pending. No public permission schema, CLI/Dashboard/I213 or Windows spawn authority. |
