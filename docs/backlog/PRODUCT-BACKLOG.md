...
| I225 / TOOL-024-D1-A Windows Job Object decision | Active / Claimed proposed by #388; ineffective until merge | Decision-only ADR-068/current-path prerequisite; no Windows implementation authority until a later D1-B claim. |
