...
| 0 | TUI Native Selection And Copy | TUI-046-A/I184 is in Review with application-owned selection selected; after A acceptance, claim B and start implementation immediately. Cross-platform terminal testing is a B merge-acceptance gate, not a development prerequisite. | `docs/backlog/active/TUI-046-native-text-selection-copy.md`; `docs/iterations/I184-tui-046a-selection-policy.md`; ADR-054; `docs/reference/TUI-NATIVE-SELECTION-MATRIX.md` |
