...
| 0 | TUI Native Selection And Copy | TUI-046-A/I184 is Complete; I186 proposes the separate TUI-046-B application-owned selection implementation claim. Cross-platform terminal testing is a B merge-acceptance gate, not a development prerequisite. | `docs/backlog/active/TUI-046-native-text-selection-copy.md`; `docs/iterations/I186-tui-visible-cell-selection.md`; ADR-054; `docs/reference/TUI-NATIVE-SELECTION-MATRIX.md` |
