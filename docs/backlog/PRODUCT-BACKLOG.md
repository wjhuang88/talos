...
| 1 | Supervised background command jobs | TOOL-024-B/I222 and C/I224 are Complete/Closed. D1-A/I225 is a Planned/Unclaimed decision-only prerequisite; D1-B, D2 and I223 remain blocked/separate, and Windows stays fail-closed. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-D1-A-windows-job-object-decision.md`; `docs/iterations/I225-tool024d1a-windows-job-object-decision.md`; `docs/iterations/I223-issue59-deferred-human-validation-cleanup.md`; `docs/tasks/2026-08-23-issue59-supervised-background-jobs.md` |
...
| I225 / TOOL-024-D1-A Windows Job Object decision | Planned / Unclaimed | Decision-only ADR-068/current-path prerequisite; no Windows implementation authority until a later D1-B claim. |
