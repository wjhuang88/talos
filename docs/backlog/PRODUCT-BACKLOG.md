...
| 0 | Ordered mainline priority requirements | Planned long task with proposed coordination claim PR #227 orders I196 → I188/#59 → I197/#125 → I198/#155, then conditionally revisits #59 production slices. The claim is ineffective before `main`; it activates nothing and does not bypass separate child claims or TOOL-024 dependencies. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I196; I188; I197; I198 |
...
| 1 | TUI regression intake | TUI-045/Issue #125 is Ready with I197 Planned/Unclaimed in the ordered mainline task; TUI-043 is Ready, while TUI-041/TUI-042 retain their own refinement gates. Issue #134 remains separately completed through TUI-046-A/B. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/iterations/I197-tui045-permission-prompt-anchor-stability.md` |
...
| SKILL-004 / I198 | Ready / Planned / Unclaimed | Follow I197 disposition, establish a separate effective claim, and confirm the omitted-`triggers` compatibility contract before parser edits. |
