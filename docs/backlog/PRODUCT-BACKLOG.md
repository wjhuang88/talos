...
| 0 | Change-aware CI routing | I190/GOV-005 is Active after claim merge `bb38c262`: implement a fail-closed documentation-only classifier so prose changes retain governance/document gates without unconditional Unix/Windows Rust workspace tests. | `docs/backlog/active/GOV-005-change-aware-ci-routing.md`; `docs/iterations/I190-change-aware-ci-routing.md` |
