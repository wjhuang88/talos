...
| 0 | Permission pipeline convergence | A/I189, B/I219, I220 and C/I221 are Complete/Closed. I221 Completion Commit `49d1546c` reached main through PR #376 merge `f9e6706d`; D/E, `/auto` behavior and TOOL-024 remain separately governed. | `docs/backlog/active/PERM-006-permission-pipeline-convergence.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md`; `docs/iterations/I221-perm006c-agent-owned-pipeline.md`; `docs/iterations/I220-perm006c-agent-owned-pipeline-decision.md`; `docs/decisions/067-agent-owned-permission-pipeline.md` |
...
| 1 | Supervised background command jobs | I188/TOOL-024-A, TOOL-023-C, all RUNTIME-005 children and PERM-006-C are Complete. Production B remains blocked until a separate child owner/iteration/claim is effective; Windows remains fail-closed pending D. Issue #59 stays open. | `docs/backlog/active/TOOL-024-background-command-jobs.md`; `docs/backlog/active/TOOL-024-A-background-job-lifecycle-spike.md`; `docs/iterations/I188-tool024a-background-job-contract.md`; `docs/backlog/active/RUNTIME-005-bounded-graceful-shutdown.md`; `docs/backlog/active/PERM-006-C-agent-owned-permission-pipeline.md` |
