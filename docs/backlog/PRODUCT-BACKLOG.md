...
| ARCH-034-R03 / I173 | Ready / Planned claim proposal | Claim-only Todo model/repository/formatting/tool-adapter decomposition; preserve public paths, SQL, schemas, permissions, contribution order, and output. |
