...
| ARCH-034-R11 / I180 | Planned / claim preparation | Documentation-truth reconciliation selected; implementation is not authorized until a finalized governance claim merges to `main`. |
