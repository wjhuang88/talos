...
| 0 | Ordered mainline priority requirements | Coordination claim and Deferred Human Validation Mode are effective. I200/I197/I201/I212/I210/I198 have terminal implementation merge dispositions and remain Review for Issue #302/I211. I211 evidence-only claim preparation is next. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211 |
| 0 | Deferred human review and acceptance batch | VALIDATION-002 / I211 remains Planned / Unclaimed from Issue #302 while a governance-only claim is prepared. All ordered implementation dispositions are terminal; no human row or product repair is authorized before the claim reaches `main`. | `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md`; `docs/iterations/I211-deferred-human-validation-batch.md`; Issue #302 |
...
| SKILL-004 | Review / Claimed — I198 implementation merged | PR #325 final head `b2d5adaf` passed exact-head CI/review/CAS and merged as `15a3d424`; only Issue #302 human compatibility validation remains open. [Owner](active/SKILL-004-optional-skill-triggers-compatibility.md) |
