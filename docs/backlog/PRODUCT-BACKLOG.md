...
| 1 | Dashboard live activity and log viewer | WEB-001-B / I213 is Active/Claimed through activation PR #363 merge `e578f419`. Controlled pairwise exceptions cover I219 permission execution, I220 decision-only ADR-067 docs and I222-B's non-overlapping core/agent/tools/runtime slice. Authority or production overlap stops only the affected lane; each lane requires separate exact-head CI/review/CAS. | `docs/backlog/active/WEB-001-B-dashboard-live-activity-log-viewer.md`; `docs/iterations/I213-dashboard-live-activity-log-viewer.md`; `docs/backlog/active/WEB-001-embedded-web-control-surface.md`; ADR-006; ADR-031; OBS-001/ADR-014 |
...
| I213 / WEB-001-B | Active / Claimed | Activation PR #363 merged as `e578f419`; controlled pairwise exceptions are I219 permission execution, I220 decision-only ADR-067 docs and I222-B core/agent/tools/runtime work excluding I213 production files. Every lane retains independent exact-head evidence and CAS. |
...
| I222 / TOOL-024-B managed background core | Active / Claimed | PR #379 merged as `48e8ae9b` after CI `32650593056`, review `5386970071` and CAS; bounded parallel pair with I213 under `5386904546`; Unix-only core with no CLI/Dashboard/Windows process spawn. |
