...
| 0 | TUI Native Selection And Copy | TUI-046-A/I184 is Active from claim merge `66d0f932`; decide the ADR-054 contract and record two-terminal causal evidence before TUI-046-B implementation. | `docs/backlog/active/TUI-046-native-text-selection-copy.md`; `docs/iterations/I184-tui-046a-selection-policy.md`; ADR-054; `docs/reference/TUI-NATIVE-SELECTION-MATRIX.md` |
