...
|---|---|---|---|
| 0 | Goal-oriented work and evaluation foundation | WORK-001-A / I196 is the proposed P0 decision and migration-contract slice. Its Draft claim remains ineffective until finalized, independently reviewed and merged to `main`; P1-P4 remain separate blocked future owners and no Work Graph, Evaluator or Desktop implementation is authorized. | `docs/backlog/active/WORK-001-goal-oriented-work-evaluation-foundation.md`; `docs/backlog/active/WORK-001-A-work-domain-decision-migration-contract.md`; `docs/iterations/I196-work-domain-decision-migration-contract.md`; DESKTOP-001; RUNTIME-001; SESSION-009; TODO-001; TODO-002; VALIDATION-001 |
...
|---|---|---|
| WORK-001-A / I196 | Ready / proposed claim | Finalize the governance-only claim, pass exact-head governance/CI and independent review, repeat merge-time CAS, and merge it to `main` before creating the P0 decision implementation branch. |
