...
|---|---|---|
| ARCH-031-A / I159 | Ready / proposed claim | Merge the finalized I159 claim to `main` before creating its implementation branch; I160-I162 remain blocked in order. |
