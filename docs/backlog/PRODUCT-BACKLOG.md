...
| 1 | TUI regression intake | TUI-041/I199 and TUI-042/I200 are Complete/Closed. I197 remains Review under TUI-059/#330; I229/TUI-058/#329 is Complete/Closed, while I201/#111 retains its deferred natural-person acceptance state; TUI-061/#334 separately owns the continuation-padding regression. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/backlog/active/TUI-058-permission-mediated-tool-activity-correlation.md`; `docs/iterations/I229-tui058-permission-tool-correlation.md`; `docs/backlog/active/TUI-059-permission-prompt-composer-docking.md`; `docs/backlog/active/TUI-061-history-continuation-padding-regression.md`; `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md` |
