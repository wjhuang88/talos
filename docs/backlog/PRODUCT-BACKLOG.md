...
| MEM-002 | Conversation context continuity | **Ready** (→ I024) | P0 | P0 — agent has no memory across turns. JSONL storage and Compactor exist but are not wired into the agent turn loop. Split from I019 as Working Memory + Episodic Memory prerequisite. | `docs/backlog/active/MEM-002-conversation-context-continuity.md`; `docs/iterations/I024-conversation-context.md`; `docs/proposals/session-context-contamination.md`; ADR-016 |
