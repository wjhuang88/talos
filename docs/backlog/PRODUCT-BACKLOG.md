...
| 1 | Model-assisted auto permission decisions | PERM-007-A/I218, B/I233 and C/I234 are Complete/Closed; D/I236 is Active/Claimed from `main@1ea3d99d`. I234 Completion Commit `7ddba098b5929e593fff94b9d3f5fd10f2fb35c1`; PR #434 merged as `c5be0109b3da4f81e221fa37f734af2431e35255`. | `docs/backlog/active/PERM-007-model-assisted-goal-permission-decisions.md`; `docs/backlog/active/PERM-007-B-auto-config-session-command.md`; `docs/backlog/active/PERM-007-C-model-assisted-resolver.md`; `docs/iterations/I218-perm007a-auto-permission-security-decision.md`; `docs/iterations/I233-perm007b-auto-config-session-command.md`; `docs/iterations/I234-perm007c-model-assisted-resolver.md`; `docs/iterations/I236-perm007d-cross-surface-conformance.md`; ADR-064; Issue #188 |
| 0 | Model-first permission triage follow-up | PERM-007-E / I241 is Refinement / Unclaimed; ADR-069 is Proposed and must be accepted before implementation. | `docs/backlog/active/PERM-007-E-model-first-permission-triage.md`; `docs/iterations/I241-perm007e-model-first-permission-triage.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
| 0 | PERM-007-E security decision | I242 is Refinement / Unclaimed; decision-only review and acceptance/rejection of ADR-069 before I241 implementation. | `docs/iterations/I242-perm007e-security-decision.md`; `docs/decisions/069-model-first-permission-triage.md`; Issue #456 |
| 1 | PERM-007-C capability decision | I235 Active / Claimed; decision-only prerequisite for I234; claim PR #432; no implementation authority. | `docs/backlog/active/PERM-007-C0-atomic-create-capability-decision.md`; `docs/iterations/I235-perm007c-atomic-create-capability-decision.md`; ADR-064; Issue #188 |
