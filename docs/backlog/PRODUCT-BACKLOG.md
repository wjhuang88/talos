...
|---|---|---|---|
| 0 | v0.8.0 GitHub-first crates publication | I159/I160/I161/I162 Complete; I162 Completion Commit `077b347d`, PR #255 merged as `16564ba0`, reviewed readiness NO-GO. I203/REL-003 remains blocked until a reviewed I162 GO packet, then releases GitHub v0.8.0 before any Cargo publication. The intended closure is 20 packages excluding only `talos-models`. | `docs/tasks/2026-08-14-v080-github-first-crates-publication.md`; `docs/backlog/active/ARCH-031-crate-publication-boundary.md`; `docs/backlog/active/ARCH-031-D-v0.6-sdk-publication-readiness.md`; `docs/iterations/I159-talos-tools-feature-boundary.md`; `docs/iterations/I160-shared-cli-runtime-composition.md`; `docs/iterations/I161-sandbox-fallback-and-coding-preset.md`; `docs/iterations/I162-v0.6-sdk-publication-readiness.md`; `docs/backlog/active/REL-003-v080-github-and-crates-publication.md`; `docs/iterations/I203-v080-github-and-crates-publication.md` |
| 0 | v0.8.0 release-candidate registry readiness | ARCH-031-E / I204 is Active/In Progress/Claimed after claim PR #257 merged as `e6cab51a`. It addresses the I162 reviewed NO-GO with candidate-only `0.8.0` version alignment, registry visibility, metadata closure and package/dry-run evidence. I203 remains Blocked/Unclaimed until a reviewed GO packet; no release or publication is authorized. | `docs/backlog/active/ARCH-031-E-v080-release-candidate-readiness.md`; `docs/iterations/I204-v080-release-candidate-readiness.md`; `docs/reference/I162-PUBLICATION-READINESS-2026-08-15.md`; `docs/iterations/I203-v080-github-and-crates-publication.md` |
