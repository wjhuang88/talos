...
|---|---|---|---|
| 1 | Dependency baseline and upgrade governance / #474 | DEPENDENCY-001 / I248 Active/Claimed via #496 merge `7c3f6421`; local implementation convergence. Baseline, Bash/PowerShell audit, generic SOP and live candidate handoff; full dependency upgrade remains a separate long-task outcome, not satisfied by one pilot. | `docs/backlog/active/DEPENDENCY-001-dependency-upgrade-governance.md`; `docs/iterations/I248-dependency-governance-closed-loop.md`; `docs/tasks/2026-09-06-dependency-governance-recovery.md`; Issue #474 |
