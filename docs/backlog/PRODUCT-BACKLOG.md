...
| SKILL-004 | Ready — I198 claim proposed in PR #324; ineffective while open | Optional `SKILL.md` triggers compatibility has an additive contract checkpoint and bounded parser/docs slice. Implementation waits for the exact-head claim merge. [Owner](active/SKILL-004-optional-skill-triggers-compatibility.md) |
