...
| 1 | Steering follow-up sequence | TUI-048/I206 is Review/Claimed after #410 merge `c3a121f0`; local candidate activates accepted steering after requested Esc cancellation and restores provider switching after queue drain. Exact-head evidence and merge remain pending. TUI-049/I207 and TUI-050/I208 remain Planned/Unclaimed. | `docs/tasks/2026-08-17-steering-follow-up-sequence.md`; `docs/backlog/active/TUI-048-steering-esc-activation.md`; `docs/iterations/I206-tui048-steering-esc-activation.md`; `docs/backlog/active/TUI-049-steering-wrap-padding.md`; `docs/backlog/active/TUI-050-steering-insertion-boundary.md`; Issues #267/#408 |
