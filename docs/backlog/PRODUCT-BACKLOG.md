...
| 0 | Ordered mainline priority requirements | I211 is Active through activation merge `a2f43248`; all six source children remain Review. Initial failures are owned by TUI-058/#329 and TUI-059/#330; remaining Issue #302 rows are pending. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I212; I210; I198; I211 |
| 0 | Deferred human review and acceptance batch | VALIDATION-002 / I211 is Active/Claimed. Partial human evidence is classified without false completion; failed rows have separate unclaimed corrective owners and remaining matrices stay open. | `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md`; `docs/iterations/I211-deferred-human-validation-batch.md`; Issues #302/#329/#330 |
...
| 1 | TUI regression intake | TUI-041/#69 and I199 are Complete/Closed. I200/I197/I201 remain Review under I211. TUI-058/#329 and TUI-059/#330 are Ready/Unclaimed corrective owners for the failed permission-mediated activity and composer-docking rows. | `docs/backlog/active/TUI-041-thinking-preview-wrap-and-height.md`; `docs/backlog/active/TUI-042-noop-history-scroll-stability.md`; `docs/backlog/active/TUI-043-tool-placeholder-suppression.md`; `docs/backlog/active/TUI-045-permission-prompt-layout-anchor.md`; `docs/backlog/active/TUI-058-permission-mediated-tool-activity-correlation.md`; `docs/backlog/active/TUI-059-permission-prompt-composer-docking.md`; `docs/backlog/active/VALIDATION-002-deferred-human-validation-batch.md` |
