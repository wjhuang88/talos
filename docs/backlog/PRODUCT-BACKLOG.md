...
| 0 | Ordered mainline priority requirements | Coordination claim effective through #227. I188 is Complete; GOV-007/I205 is next before I196. No child is activated solely by the long task. | `docs/tasks/2026-08-14-mainline-priority-requirements-sequence.md`; I205; I196; I188; I199; I200; I197; I201; I198 |
| 0 | PR workflow throughput simplification | GOV-007 / I205 is In Progress / Active / Claimed through #284 merge `fd1eaad9`. Measure recent delivery churn and select a smaller evidence-preserving flow without changing executable governance. | `docs/backlog/active/GOV-007-pr-workflow-throughput-simplification.md`; `docs/iterations/I205-pr-workflow-throughput-simplification.md`; collaboration/Git/DOC-CHECK/CI SOPs |
