...
| I220 / PERM-006-C decision prerequisite | Active / Claimed proposed by #370; ineffective until merge | A/B complete. Decision-only ADR-067/current-path/migration work is authorized in parallel with I213 under explicit non-overlap; I213 owner is reconciled and final CAS remains the merge gate. No C implementation authority. |
