...
|---|---|---|---|
| 0 | v0.8.0 GitHub-first crates publication | I159/ARCH-031-A is Complete through PR #236 merge `f79c1ead`; ARCH-031-B/I160 implementation is in Review after PR #240 merged as `97556149` (CI `31824945312`, approval `5296616991`), with Completion Commit still pending. I161-I162 remain blocked in order, then I203/REL-003 releases GitHub v0.8.0 before any Cargo publication. The intended closure is 20 packages excluding only `talos-models`; I162 must produce the exact GO packet. | `docs/tasks/2026-08-14-v080-github-first-crates-publication.md`; `docs/backlog/active/ARCH-031-crate-publication-boundary.md`; `docs/iterations/I159-talos-tools-feature-boundary.md`; `docs/iterations/I160-shared-cli-runtime-composition.md`; `docs/iterations/I162-v0.6-sdk-publication-readiness.md`; `docs/backlog/active/REL-003-v080-github-and-crates-publication.md`; `docs/iterations/I203-v080-github-and-crates-publication.md` |
...
| ARCH-031-B / I160 | Review / implementation merged | Claim PR #238 merged as `71faf844`; implementation PR #240 merged as `97556149` after CI `31824945312` and approval `5296616991`; Completion Commit remains pending and I161-I162 remain blocked in order. |
