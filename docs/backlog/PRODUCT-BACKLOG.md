...
| 1 | TUI interaction intake | TUI-051/#272, TUI-052/#266, TUI-053/#268 and TUI-054/#269 are Intake / Unclaimed with no selected iteration. TUI-051 waits for #271 terminal disposition; the others require decomposition/overlap checks before selection. | `docs/backlog/active/TUI-051-resumed-session-interactivity.md`; `docs/backlog/active/TUI-052-todo-rendering-muted-readability.md`; `docs/backlog/active/TUI-053-numeric-permission-shortcuts.md`; `docs/backlog/active/TUI-054-native-key-repeat-routing.md` |
...
| 0 | Provider streaming UTF-8 containment | PROVIDER-005 / Issue #270 is in Review under Emergency override through PR #271. Valid multibyte characters split across transport chunks must not abort a live turn; invalid bytes remain fail-closed. | `docs/backlog/active/PROVIDER-005-streaming-utf8-chunk-boundary.md`; Issue #270; PR #271 |
