...
`PRODUCT-BACKLOG.md` is currently a large monolithic backlog. The updated governance rule now
requires compaction before more large planning waves are added. See
[`docs/backlog/archive/2026-Q2/GOV-001-backlog-compaction.md`](GOV-001-backlog-compaction.md).
