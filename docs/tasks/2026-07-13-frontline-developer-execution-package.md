...
**Status**: Long-task in progress; I120/I121/I122 Complete; I123 ready for activation
...
| 2026-07-13 | I123 Gate 0 / activation | `feature/i123-installation-and-trial-confidence` (branch from I122 HEAD) | In Progress | git status clean; rustc 1.97.0 (pinned); `cargo metadata --locked` exit 0; governance 0 warnings; `release_preflight.sh` passed. No other iteration Active (I122 now Complete, I123 newly Active). | `I123-installation-and-trial-confidence.md`, `iterations/README.md`, BOARD.md, this package | none | Begin F130: POSIX/PowerShell installer fixture matrix. |
