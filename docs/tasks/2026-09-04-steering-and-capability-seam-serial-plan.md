...
**Status**: Active coordination / I207 Review / Claimed (implementation merged; closeout pending)
...
|---|---|---|
| I207 / TUI-049 | Review / Claimed | Implementation PR #483 merged as `ca3b2fa7`; closeout awaits real-terminal evidence and independent closeout review before I208. |
...
| S1 | Implement I207 / TUI-049 | Padding-correct steering wrapping with focused and terminal evidence | S0 | Owner acceptance, local locked checks, exact-head review/CI, merge and closeout | Preserve existing layout and record residual | Review; implementation merged as `ca3b2fa7`, closeout pending real-terminal evidence |
| S2 | Establish I208 claim after I207 disposition | Effective I208 claim and active owner | S1 terminal; current-main refresh | Governance PR merged and CAS pass | Keep I208 Planned/Unclaimed | Planned; blocked by I207 closeout |
