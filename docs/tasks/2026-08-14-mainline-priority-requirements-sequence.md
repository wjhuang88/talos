...
| ID | Task | Expected Output | Depends On | Completion Gate | Fallback | Status |
|---|---|---|---|---|---|---|
| T0A | Claim and deliver I205 / GOV-007 | Reproducible PR/review audit, target-flow decision, scenario matrix, migration/rollback and smallest implementation slice | T0 planning publication | Effective I205 claim, owner acceptance, exact-head validation/review/CAS and owner-first closeout | Keep current workflow unchanged and record measured blockers | Review |
