...
| T1 | Establish and deliver I196 / WORK-001-A | Accepted P0 architecture decision, inventory and migration/rollback contract | T0 and effective PR #226 claim | I196 owner acceptance, implementation PR, exact-head evidence and owner-first closeout | Keep I196 Review/Partial; do not begin P1 behavior work | Active |
