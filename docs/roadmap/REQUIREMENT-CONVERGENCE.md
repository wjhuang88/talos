...
|---|---|---|---|---|
| Permanent dependency baseline, audit and upgrade SOP / #474 | #474 full acceptance and recovery ledger | DEPENDENCY-001 / I248 | #496 merged at `7c3f6421`; Active/Claimed, implementation locally converging | Real accepted baseline, deterministic Bash/Pwsh parity, latest-stable live report, bounded candidate handoff, generic SOP and validated implementation merge; full dependency upgrade is an additional long-task outcome, not satisfied by the pilot |
...
| Progressive capability provider architecture governance / #466 | ADR-072; CAP-001-G / I253 / #519 | CAP-001 child map and owners; Issues #508-#517 | I253 Complete / Closed; CAP-001 remains Refinement / Unclaimed | Governance audit and migration contracts completed through `60851fb`. Select one dependency-ready child at a time with its own claim and implementation evidence. No child is authorized by the intake map. |
