...
| Progressive capability provider architecture governance / #466 | ADR-072; CAP-001-G / I253 / #519 | CAP-001 child map and owners; Issues #508-#517 | Active / Claimed (effective via #518 merge `53fc57b3`) | Complete the governance audit and migration contracts first; then select one dependency-ready child at a time with its own claim and implementation evidence. No child is authorized by the intake map. |
