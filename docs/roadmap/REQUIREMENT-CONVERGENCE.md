...
| Progressive capability provider architecture governance / #466 | ADR-072; CAP-001-G / I253 | CAP-001 child map and owners; Issues #508-#517 | Planned / Unclaimed | Complete the governance audit and migration contracts first; then select one dependency-ready child at a time with its own claim and implementation evidence. No child is authorized by the intake map. |
