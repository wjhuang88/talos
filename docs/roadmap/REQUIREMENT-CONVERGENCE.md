...
| Conversation context continuity (Working + Episodic) | ADR-016; session-context-contamination proposal | MEM-002 → I024 | Planned (I024 ready) | Agent receives session history in every turn; compaction bounds context; JSONL persists episodes. Prerequisite for I019 Semantic layer. |
