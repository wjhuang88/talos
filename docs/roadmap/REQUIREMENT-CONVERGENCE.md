...
|---|---|---|---|---|
| Permanent dependency baseline, audit and upgrade SOP / #474 | #474 full acceptance and recovery ledger | DEPENDENCY-001 / I248 | #496 atomic claim proposal; ineffective until merge | Real accepted baseline, deterministic Bash/Pwsh parity, latest-stable live report, bounded candidate handoff, generic SOP and validated implementation merge; no dependency upgrade required |
