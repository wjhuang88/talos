...
| ARCH-031 Crate Publication Boundary | In Progress (rate-limited) | [ARCH-031](backlog/active/ARCH-031-crate-publication-boundary.md) / [matrix](reference/CRATE-PUBLICATION-MATRIX.md) | Published: `talos-core`, `talos-skill`, `talos-config`, `talos-permission`, `talos-session`, `talos-plugin`, and `talos-memory` 0.2.0. `talos-exploration` dry-run passed but crates.io rate-limited real upload until 2026-06-29 07:28:33 GMT. |
