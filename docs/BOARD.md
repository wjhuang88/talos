...
| ARCH-031 Crate Publication Boundary | Planned | [ARCH-031](backlog/active/ARCH-031-crate-publication-boundary.md) | Architecture proposal created; activate after tool permission/loading gates or when preparing first crates.io dry-run wave. |
