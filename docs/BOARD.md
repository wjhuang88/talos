...
| Architect-Owned High-Risk Work Group | Active grouping | [High-risk group](tasks/2026-06-28-architect-owned-high-risk-work-group.md) | RUNTIME-001 boundary decision and first facade slice have landed; next high-risk packet is runtime protocol cleanup and SDK hardening. |
...
| RUNTIME-001 Embeddable Agent Runtime API | Active (partial facade landed) | [RUNTIME-001](backlog/active/RUNTIME-001-embeddable-agent-runtime-api.md) | Continue with protocol serialization tests, product-neutral session policy, diagnostic API extraction, and SDK docs before claiming a stable embedding surface. |
