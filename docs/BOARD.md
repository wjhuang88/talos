...
| ARCH-031 Crate Publication Boundary | Planned delegation active | [ARCH-031](backlog/active/ARCH-031-crate-publication-boundary.md) / [two-month plan](tasks/2026-06-29-crate-distribution-hardening-two-month-plan.md) / [handoff](tasks/2026-06-29-programmer-handoff-crate-distribution-hardening.md) | 11 crates published at 0.2.0; product-only crates have `publish = false`; handoff delegates distribution hardening plus WEBFETCH document capture, MODEL-004 runtime catalog integration, CONF-001 config editing, and AGENT-002-B shared skill discovery. |
