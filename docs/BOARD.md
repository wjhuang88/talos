...
| WEB-005 Browser Session Continuity | Research | [WEB-005](backlog/active/WEB-005-browser-session-continuity-research.md) | Study Tencent BrowserSkill's existing-login browser context, isolated agent windows, explicit tab handoff, remembered page records, and human-in-loop auth/captcha flows before any browser automation commitment. |
