...
| TOOL-014 Conditional Tool Backends | Partial (core complete) | [TOOL-014](backlog/active/TOOL-014-conditional-tool-backends.md) | Backend/schema disclosure core landed with execution guard and tests; continuation result protocol and `fetch_url` backend migration remain. |
