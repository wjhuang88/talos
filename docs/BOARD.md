...
| ARCH-031 Crate Publication Boundary | In Progress (readiness only) | [ARCH-031](backlog/active/ARCH-031-crate-publication-boundary.md) / [matrix](reference/CRATE-PUBLICATION-MATRIX.md) | `talos-core` and `talos-skill` dry-run pass; real crates.io publish/name reservation requires explicit maintainer approval. |
