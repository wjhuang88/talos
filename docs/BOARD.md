...
| Architect-Owned High-Risk Work Group | Active grouping | [High-risk group](tasks/2026-06-28-architect-owned-high-risk-work-group.md) | RUNTIME-001, TOOL-004, TOOL-007, and TOOL-013 are complete. Next H2 work is TOOL-012 progressive loading; TOOL-011 can stabilize grep when needed. |
...
| WEBFETCH-001 Web And Document Fetch Tools | Phase 0/1 Complete; Phase 2+ Research | [WEBFETCH-001](backlog/active/WEBFETCH-001-web-and-document-fetch-tools.md) | Phase 2+ remains gated by TOOL-012 progressive-loading/result-boundary design; TOOL-013 hybrid permission classification is complete. |
...
| TOOL-012 Tool Family Progressive Loading | Planned | [TOOL-012](backlog/active/TOOL-012-tool-family-progressive-loading.md) | Next H2 gate after TOOL-013 completion; define family metadata and prompt/provider presentation policy. |
| TOOL-013 Multi-Resource Tool Permissions | Complete | [TOOL-013](backlog/active/TOOL-013-multi-resource-tool-permissions.md) | Profile-based multi-facet permission evaluation landed across Agent, CLI/TUI, MCP, and runtime. Next H2 gate is TOOL-012 progressive loading. |
