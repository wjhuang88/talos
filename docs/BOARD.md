...
| Architect-Owned High-Risk Work Group | Active grouping | [High-risk group](tasks/2026-06-28-architect-owned-high-risk-work-group.md) | RUNTIME-001, TOOL-004, and TOOL-007 are complete. Next H2 work is TOOL-013 multi-resource permissions, then TOOL-012 progressive loading; TOOL-011 can stabilize grep when needed. |
...
| WEBFETCH-001 Web And Document Fetch Tools | Phase 0/1 Complete; Phase 2+ Research | [WEBFETCH-001](backlog/active/WEBFETCH-001-web-and-document-fetch-tools.md) | Phase 2+ remains gated by TOOL-013 hybrid permission classification and TOOL-012 progressive-loading/result-boundary design. |
...
| TOOL-012 Tool Family Progressive Loading | Planned | [TOOL-012](backlog/active/TOOL-012-tool-family-progressive-loading.md) | Activate after TOOL-013 or alongside it if prompt/cache pressure becomes the primary H2 blocker. |
| TOOL-013 Multi-Resource Tool Permissions | Planned | [TOOL-013](backlog/active/TOOL-013-multi-resource-tool-permissions.md) | Next H2 implementation/design gate before WEBFETCH Phase 2+ save/extract expansion. |
