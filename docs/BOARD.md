...
| WEB-002 GitHub Pages Product Site And Custom Domain | Ready for delegated assignment | [WEB-002](backlog/active/WEB-002-github-pages-product-site.md) / [handoff](tasks/2026-06-29-delegable-product-site-docs-two-month-plan.md) | Assign static `site/` and user-doc sync work from the handoff; do not include WEB-001 runtime control, DNS cutover, release publishing, or Pages settings changes without approval. |
