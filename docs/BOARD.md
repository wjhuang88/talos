...
| Architect-Owned High-Risk Work Group | Active grouping | [High-risk group](tasks/2026-06-28-architect-owned-high-risk-work-group.md) | RUNTIME-001 is complete as a pre-1.0 facade; next direct-owned packet is H2 tool family and ingestion architecture (`TOOL-004` before `TOOL-007`, with `WEBFETCH-001` included). |
