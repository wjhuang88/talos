...
| I046 Architecture, Structure, And Governance Repair | Planned | [I046](iterations/I046-architecture-structure-governance-repair.md) | Activate before new feature work if post-I045 repair is selected: restore workspace tests, provider-aware model identity, inline api_key boundary, model lifecycle structure cleanup, and docs sync |
