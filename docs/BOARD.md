...
| I049 Storage Status And Cleanup CLI | Planned | [I049](iterations/I049-storage-status-and-cleanup-cli.md) | Continue DATA-001 into user-facing CLI status/cleanup; activate after I048/release evidence disposition |
| I050 Memory Consolidation Pipeline | Planned | [I050](iterations/I050-memory-consolidation-pipeline.md) | Activate only after DATA-001 lifecycle controls complete or change-control exception is recorded |
| I051 Bounded Memory Prompt Injection | Planned | [I051](iterations/I051-bounded-memory-prompt-injection.md) | Depends on I050 consolidation evidence and hidden-output prompt guard |
| I052 Procedural Memory And Entity Linking | Planned | [I052](iterations/I052-procedural-memory-and-entity-linking.md) | Depends on bounded memory prompt injection; procedural memory remains advisory only |
| I053 Memory Quality And Release Hardening | Planned | [I053](iterations/I053-memory-quality-and-release-hardening.md) | Close I019 quality, retention dry-run, docs, and release-quality evidence before I020 |
| I054 Exploration Library Storage Foundation | Planned | [I054](iterations/I054-exploration-library-storage-foundation.md) | Start I020 only after I019 memory quality gate or explicit research-priority replan |
| I055 Exploration Ingestion And Citation Workflow | Planned | [I055](iterations/I055-exploration-ingestion-and-citation-workflow.md) | Depends on I054 storage foundation and permission-aware ingestion boundary |
| I056 Two-Month Closeout And v0.2.0 Readiness | Planned | [I056](iterations/I056-two-month-closeout-and-v020-readiness.md) | Close the long task, record residuals, and prepare release decision; no tag without approval |
