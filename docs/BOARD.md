...
| Architect-Owned High-Risk Work Group | Active grouping | [High-risk group](tasks/2026-06-28-architect-owned-high-risk-work-group.md) | Use this as the direct-oversight set before selecting high-risk implementation packets; next packet is RUNTIME-001 API audit and boundary decision. |
...
| RUNTIME-001 Embeddable Agent Runtime API | Planned | [RUNTIME-001](backlog/active/RUNTIME-001-embeddable-agent-runtime-api.md) | Activate as a medium-term SDK boundary slice before exposing deeper remote/plugin runtime surfaces to external projects. |
