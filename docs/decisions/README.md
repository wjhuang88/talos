...
| [069: Model-First Permission Triage](069-model-first-permission-triage.md) | **Proposed / I241 Refinement** | Separate follow-up boundary for deterministic-first, model-assisted triage of bounded read-only/local-validation requests. ADR-064 remains unchanged; no implementation authority exists until I241 claim and independent security review. |
