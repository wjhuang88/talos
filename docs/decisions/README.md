...
|---|---|---|
| [063: Bounded Runtime Shutdown And Finalizer Coordination](063-bounded-runtime-shutdown-finalization.md) | **Proposed / I214 Active** | One runtime-local coordinator, first-valid-request arbitration, atomic SDK admission fence, one total deadline, actor-owned ADR-058 reconciliation, frozen ordered finalizers and a redacted shared report are proposed. RUNTIME-005-B/C and TOOL-024 implementation remain separately blocked. |
