...
31. [031: WEB-001 Loopback Dashboard Boundary](031-web-loopback-dashboard-boundary.md) — Accepted (2026-07-01; amended 2026-07-02). Clears the WEB-001 design gate for a default-on TUI loopback-only, token-authenticated, read-only dashboard MVP with config opt-out; no remote access, write routes, approvals, or browser automation.
