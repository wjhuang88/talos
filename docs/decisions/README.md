...
|---|---|---|
| [070: Shell Auto Classifier Context And Precedence](070-shell-auto-classifier-context.md) | **Proposed / I243 Refinement** | Claude-like shell classification after deterministic Deny/Ask, using isolated exact-action and trusted-environment context. Decision-only; I244 implementation remains Blocked/Unclaimed. |
