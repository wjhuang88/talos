...
|---|---|---|
| [065: Encapsulated Permission Rules And Diagnostic Provenance](065-structured-permission-rule-provenance.md) | **Accepted / I189 Review** | Decision content commit `dae98460` became effective through PR #355 merge `9579df7a`, exact-head CI `32508015164`, independent Agent-role security/API review `5373150265` and CAS. Serialized `PermissionRule` and decisions remain compatible; implementation commit `6b577d6a` is separately in Review through PR #356. |
