...
|---|---|---|
| [068: Windows Job Object Process Ownership](068-windows-job-object-process-ownership.md) | **Proposed / I225 Review** | Decision-only contract for assigned-before-exec Job Object ownership, allowlisted stdio handles, kill-on-close descendants, bounded OS-ABI/unsafe and fail-closed migration. D1-B implementation remains separately gated; Windows background admission remains fail-closed. |
