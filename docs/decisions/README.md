...
|---|---|---|
| [066: First-Class Scoped Permission Grants](066-first-class-scoped-permission-grants.md) | **Accepted / PERM-006-B Unclaimed** | Decision content commit `17088d88` separates session grants from policy rules and freezes Deny/multi-facet/provenance/external-path boundaries plus the v0.9+ API migration. Exact-head Proposed review `5376959300`, CI `32541156457` and maintainer acceptance `5378407820` establish the decision only; implementation still requires a runnable iteration and effective protected-scope claim. |
