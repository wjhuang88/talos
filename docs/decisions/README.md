...
|---|---|---|
| [058: Partial-Turn Durable Finalization Boundary](058-partial-turn-durable-finalization.md) | **Proposed / I187 Review** | Proposes one atomic, idempotent Success/Error/Cancelled finalizer, closed display-safe partial prefixes, explicit turn outcomes and first-writer conflict semantics. ADR-042 remains authoritative until review accepts this proposal. |
...
| [054: Alternate-Screen App-Owned Transcript Rendering](054-alternate-screen-app-owned-transcript-rendering.md) | Accepted; I184 amendment Accepted | TUI owns full-frame alternate-screen rendering, history reflow and terminal restoration. I184 selects bounded application-owned visible-cell selection for TUI-046-B; implementation and full terminal acceptance remain separately claimed. |
