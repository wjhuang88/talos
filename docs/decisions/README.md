...
31. [031: WEB-001 Loopback Dashboard Boundary](031-web-loopback-dashboard-boundary.md) — Accepted (2026-07-01). Clears the WEB-001 design gate for an explicit opt-in, loopback-only, token-authenticated, read-only dashboard MVP; no remote access, write routes, approvals, or browser automation.
