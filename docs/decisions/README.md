...
| [052: SDK And Composition Boundary](052-sdk-composition-boundary.md) | Accepted | Runtime/SDK publication and composition work remains gated through I158-I162; no implicit publication authorization. |
...
| [045](045-transient-model-private-tool-projection.md)–[055](055-provider-terminal-outcome-boundary.md) | model-private edit projection, memory admission, external path authorization, model variants, steering projection, multimodal/image safety, SDK/tool composition, TUI rendering and provider terminal outcomes |
