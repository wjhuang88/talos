...
|---|---|---|
| [070: Shell Auto Classifier Context And Precedence](070-shell-auto-classifier-context.md) | **Accepted / I243 Complete** | Claude-like shell classification after deterministic Deny/Ask, using isolated exact-action and trusted-environment context. Decision-only; I244 implementation remains Blocked/Unclaimed. |
