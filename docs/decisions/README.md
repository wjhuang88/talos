...
| [067: Agent-Owned Permission Pipeline And Migration Contract](067-agent-owned-permission-pipeline.md) | **Proposed / I220 Active** | I220 decision claim became effective through PR #370 merge `5b8b1488`; this ADR and the current-path matrix define the separate I221 implementation boundary. Acceptance requires independent permission/security/API review; no executable behavior is authorized by this proposal. |
