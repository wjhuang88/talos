...
|---|---|---|
| [060: Supervised Background Command Job Lifecycle](060-supervised-background-command-jobs.md) | **Proposed / I188 Active** | Session-owned bounded supervisor, explicit `background:` permission resource, live-only terminal event and Unix-first group cleanup are proposed. Production spawn still waits for A acceptance, RUNTIME-005 and PERM-006-C; Windows waits for a separate D Job Object decision. |
