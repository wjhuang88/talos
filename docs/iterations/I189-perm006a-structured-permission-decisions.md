...
> Document status: Active (effective only after the activation record reaches `main`)
...
- Activation evidence remains pending exact-head CI, both governance validators, independent security review and merge-time CAS.
