...
I285 Active / Claimed is proposed by governance PR #608 and is ineffective until merge. The task records the
...
| [I285](I285-desktop-integrated-acceptance.md) | Oct 13-19: integrated candidate and acceptance | Active / Claimed proposed by #608; ineffective until merge; predecessors merged and #29 ledger exists |
...
is Complete / Closed through #580 merge `52276f55`; native acceptance, exact-head CI
and independent Agent review passed, with completion evidence in its owner.
...
| I277 | Desktop Mock Visual and Localization Slice | Review / Claimed; acceptance Deferred | [I277](I277-desktop-mock-visual-i18n.md) / DESKTOP-001-D3 / #29; #571 merged as 707b538e and Settings #573 as 8caf2b3a; implementation delivered. Maintainer defers remaining human/device validation until conditions exist; non-blocking for I278. |
...
| ID | Codename | State | Activation / Completion Gate |
|---|---|---|---|
| I262 | OBeiBuddy Contract Clarification | Complete / Closed | [I262](I262-obeibuddy-contract-clarification.md) / INTEGRATION-001 / #520; Completion Commit `86a7ef76`; browser implementation Deferred. |
...
| I259 | Bundle Manifest Compatibility | Complete / Closed | [I259](I259-bundle-manifest-implementation.md) / BUNDLE-001 / #514; Completion Commit `137da646`; #539 merged; CI/review passed. |
| I260 | Verified Manual Bundle Installation | Complete / Closed | [I260](I260-dist001a-manual-bundle-installation.md) / DIST-001-A / #509; implementation #541 merged `7e4a0dba`. |
| I261 | Rust WASM Language Provider Vertical Slice | Complete / Closed | [I261](I261-lang002-rust-wasm-provider.md) / LANG-002 / #516; Completion Commit `935c4b86`; PR #543 merged after exact-head CI `34694711467` and independent approval `5646284106`. |
...
| I252 | Capability/Provider Descriptor Contract | Complete / Closed | [I252](I252-capability-provider-descriptor-contract.md) / CAP-001-A / Issue #466; Completion Commit `71cc03b322d80d19c3767e4ef2014fecb84c1994`; implementation PR #507 merged as `0835afc4b982a5ed409ccfb55538bbeaf6fe5eab`; exact-head CI `34294884578`; independent Agent-role approval `5596471399`. |
| I253 | Capability Architecture Governance Convergence | Complete / Closed | [I253](I253-capability-governance-convergence.md) / CAP-001-G / Issue #519 (parent #466); Completion Commit `60851fb23128a151ecbd17e86ec4730ffebb3135` via PR #521 merge. Child Issues #508-#517 remain separately governed, with no child implementation authority. |
...
| I207 | Steering Wrap Padding Contract | Complete / Closed (proposed closeout) | `TUI-049`; implementation PR #483 merged as `ca3b2fa7` and native-terminal acceptance passed; effective when closeout reaches main. |
| I208 | Steering Boundary Insertion | Complete / Closed | `TUI-050`; implementation PR #489 merged as `442d143b`; exact-head CI `33944840881`, independent review `5550116820`, human acceptance complete. |
| I246 | CAP-001-P0 Compatibility Preparation | Complete / Closed | `CAP-001-P0 / #467`; claim #491 effective at `f913d28b`; Completion Commit `9a3c1d86` via implementation #492. |
...
| I240 | Mission Final Gate And UI-Neutral Projection | Complete / Closed | WORK-001-E / Issue #29; Completion Commit `29fb900e`; PR #451 merged as `2d667085`; final head `ec136f80`, CI `33412796197` 5/5 and independent Agent-role approval `5481320406`. |
