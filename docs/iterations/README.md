...
| I123 | Installation And Trial Confidence | **Review** (2026-07-13) | Month 4. Installer fixtures (POSIX 9/9 + PowerShell 5/0/1, checksum verified, offline/ARM64 error text asserted), clean-HOME smoke (18/0/2, real session resume), Windows `v0.3.4` install/version trial passed, and honest trial report. Only the independent-operator replay remains unmet. See `I123-installation-and-trial-confidence.md`. |
