...
|---|---|---|---|
| I255 | Plugin Capability Lifecycle | Review / Claimed | [I255](I255-plugin-capability-lifecycle.md) / CAP-001-C / #513; claim #527 effective at `07066e76`; local implementation candidate; final validation and exact-head review pending. |
