...
| I022 | TUI Inline-by-Default | **Active** (core flip landed 2026-06-08) | Codex-style inline-by-default TUI: viewport at cursor y, finalized turns push to scrollback via raw ANSI `SetScrollRegion` escape codes, chat_paragraph shows only current turn. 3 atomic commits (`5ed0e5e`, `684600f`, `8cd0756`). 661 tests pass (was 652; +9 from push_history_to and chat_line_to_text_lines unit tests). I008 hook ordering preserved. Infrastructure (tui/ subdir with custom terminal, insert_history, EventBroker, FrameRequester, FrameRateLimiter, JobControl, KeyboardModes; history_cell/ subdir with HistoryCell trait and base cells; widget migration) deferred to I023. See `I022-tui-inline-default.md`; `docs/proposals/tui-codex-overhaul.md`; `docs/reference/codex-tui-architecture.md`; ADR-018. |
...
| R13: I022 TUI Inline-by-Default | Core flip landed (2026-06-08); infrastructure deferred to I023 | `I022-tui-inline-default.md` | `talos-tui` adopts Codex-style inline-by-default TUI; `EnterAlternateScreen`/`LeaveAlternateScreen` removed; finalized turns push to scrollback; chat_paragraph shows only current turn. 3 atomic commits landed; 661 tests pass; I008 hook ordering preserved. Infrastructure (tui/ subdir, history_cell/ subdir, widget migration) deferred to I023. |
