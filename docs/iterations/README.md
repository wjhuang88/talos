...
| I201 | Tool-Call Placeholder Suppression | Review / Claimed; implementation PR #309 | Issue #111 / TUI-043; implementation commits `68f4fb7b`/`d1fef291` are in Review after local locked tests and the exact-confirmation correction. Final exact-head CI/Agent review/CAS remain open; human suppression-safety validation is deferred to Issue #302 / I211. |
