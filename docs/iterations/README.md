...
| I244 | Review / Claimed (local stable candidate; claim #465 merged at `94ba2dc5`) | PERM-007-F generic shell auto-classifier implementation; exact-head CI and independent permission/security/API review remain pending. |
