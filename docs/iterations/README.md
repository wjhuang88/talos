...
| I228 | TOOL-024-D2 Interactive Projection And Cross-Platform Acceptance | Active / Claimed (proposed; ineffective until claim merge) | Governance-only claim preparation from `main@7dd04afd`; implementation starts only after claim merge. I223 remains separate. |
