...
| I207 | Steering Wrap Padding Contract | Active / Claimed (proposed) | `TUI-049`; claim/activation are ineffective until the finalized governance PR merges. No implementation code yet. |
