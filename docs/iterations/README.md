...
| I126 | Schedule Inspection And Control | **Review** (2026-07-14) | Month 3. SF120-SF123 delivered: list_scheduled_tasks (Read/Allow), cancel_scheduled_task (Execute/Ask), 8 tool tests, 3 permission regression tests. See `I126-schedule-inspection-control.md`. |
...
| I126 | Review (2026-07-14) | SF120-SF123 delivered; validation ladder green. Awaiting Complete promotion. |
