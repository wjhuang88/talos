...
| I178 | Pending Submission Store Decomposition | Planned | Governance-only claim PR #164 proposes `ARCH-034-R09` ownership; implementation is not authorized until the finalized claim merges. |
