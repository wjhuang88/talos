...
| I029 | Architecture Cleanup Completion | **Active** (2026-06-18) | Complete all ARCH-002 follow-up: anti-corruption layers (ARCH-004), clippy `--all-targets` cleanup (ARCH-007), prompt cache stability (ARCH-006), god module decomposition (ARCH-005). See `I029-architecture-cleanup-completion.md`. |
