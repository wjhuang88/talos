...
| I047 | Active | Activated 2026-06-25. One-month release-readiness/runtime-polish baseline; first phase of long-running task `docs/tasks/2026-06-25-i047-i019-memory-release-sequence.md`. |
