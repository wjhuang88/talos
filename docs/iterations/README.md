...
| I126 | Schedule Inspection And Control | **Planned; unblocked, not activated** | Month 3. Read-only list, Ask-gated cancel, bounded output, and narrow-terminal rendering. Run its activation inventory and Gate 0 before implementation. See `I126-schedule-inspection-control.md`. |
...
| I126 | Planned; unblocked | Do not implement until its activation inventory and Gate 0 are recorded. |
