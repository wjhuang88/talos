...
| I188 | TOOL-024-A Background Job Lifecycle Contract | Review / Claimed / PR #228 | Claim merge `02a35588` is effective. Implementation `245eddeb` proposes ADR-060 and the current-path matrix from exact `origin/main` `556b5a43`; independent exact-head review/CI/CAS gate merge. Production B remains dependency-gated and Windows remains fail-closed pending D. |
...
| I209 | Resumed Session Interactivity Under Provider Delay | Review / Claimed / PR #279 | TUI-051 / Issue #272; implementation `7b82fea6`/`7d90def8` awaits exact-head CI, real-terminal evidence and independent review. Retry-progress acceptance transferred to I210. |
