...
| I213 | Dashboard Live Activity And Log Viewer | Active / Claimed | Activation PR #363 merged as `e578f419`. PR #379 remains the sole original I213/I222-B parallel-contract source; I222-B's proposed reserved-`background:` permission matcher/test amendment excludes I213 production files/authority and is ineffective until merged. Each lane requires separate exact-head evidence/CAS. |
...
| I222 | TOOL-024-B Managed Background Execution Core | Active / Claimed; permission amendment pending | PR #379 merged as `48e8ae9b`; implementation is paused before permission edits until the narrow reserved-`background:` matcher/test amendment reaches `main`. No public permission schema, CLI/Dashboard/I213 or Windows spawn authority. |
