...
| I188 | TOOL-024-A Background Job Lifecycle Contract | Active / Claimed | Claim merge `02a35588` is effective. ADR-060 and the current-path matrix are being implemented from exact `origin/main` `556b5a43`; production B remains dependency-gated and Windows remains fail-closed pending D. |
