...
| I208 | Steering Boundary Insertion | Active / Claimed | `TUI-050`; claim/activation PR #487 merged as `75ca8057`; implementation branch starts from that merge and is locally converging. |
