...
| I210 | Provider Retry Progress Contract | Active / Claimed | PROVIDER-006 / Issue #278; ADR-062 accepted and claim #321 merged as `e58fbd39`. Implementation starts from this or later exact `main`; initial `Connecting…` then structured `Reconnecting… (attempt n/m)` must preserve retry policy. |
