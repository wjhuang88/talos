...
| I235 | PERM-007-C Atomic Create Capability Decision | Planned / Unclaimed | Decision-only prerequisite for I234; chooses a reviewed directory-capability primitive and platform fail-closed boundary. No implementation authority. |
