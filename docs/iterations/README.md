...
| I097 | Controlled Self-Bootstrap Rehearsal | **Active (2026-07-04)** | Attempt one controlled Talos-primary documentation-only rehearsal or record non-qualification honestly. See `I097-controlled-self-bootstrap-rehearsal.md`. |
...
| I097 | Active | Activated 2026-07-04 after I096 closeout; documentation-only controlled self-bootstrap rehearsal with explicit primary-executor boundary. |
...
| R29: High-Risk gix/Runtime/Governance Execution Set | In Progress (2026-07-04) | `../tasks/2026-07-04-high-risk-execution-gix-runtime-governance-plan.md`; `I094-gix-upgrade-git-boundary.md`; `I095-runtime-validation-evidence.md`; `I096-governance-mutation-gates.md`; `I097-controlled-self-bootstrap-rehearsal.md`; `../backlog/active/GIT-001-embedded-git-tools.md`; `../backlog/active/RUNTIME-001-embeddable-agent-runtime-api.md`; `../backlog/active/GOV-003-builtin-project-governance.md`; `../backlog/active/REL-002-v1-self-bootstrap-release-gate.md` | I097 active for documentation-only controlled self-bootstrap rehearsal. No push, publish, tag, destructive Git operation, permission-default change, native Git dependency, execution-policy expansion, silent owner-doc mutation, or v1.0 claim without a separate explicit gate. |
