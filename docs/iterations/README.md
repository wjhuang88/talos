...
| I125 | Recurring Scheduled Follow-Ups | **Review — maintainer changes required** (2026-07-14) | Validation is green, but the delivery breaks the ADR-041 public API, does not prove Delay-vs-Burst semantics or cancellation/shutdown races, lacks recurring fresh-permission and configured-provider evidence, and has user/governance documentation drift. See `I125-recurring-scheduled-followups.md`. |
...
| I125 | Review — maintainer changes required (2026-07-14) | Resolve the public-API break and complete the missed-tick, race, fresh-permission, configured-provider, and documentation evidence listed in the owner doc. |
