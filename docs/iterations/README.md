...
| I206 | Esc-Cancelled Steering Activation | Active / Claimed (proposed; ineffective until claim merge) | `TUI-048`; Issue #408 is absorbed as the provider-switch symptom. Accepted steering must become one same-Session runnable turn after Esc, then queue drain restores provider switching. No code authority until claim merge. |
