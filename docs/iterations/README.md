...
| I214 | Bounded Shutdown Contract Decision | Planned / Unclaimed | RUNTIME-005-A decision-only slice; claim preparation may proceed, but no ADR execution or Rust/Cargo/runtime change is authorized before an effective claim. |
