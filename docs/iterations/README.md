...
| I244 | Review / Claimed (implementation merged `4ba1b79f`; deferred real-TUI validation) | PERM-007-F generic shell auto-classifier implementation; closeout awaits Issue #302 validation evidence. |
