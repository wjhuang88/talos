...
| I173 | Todo Module Decomposition | Active when Claim #148 merges | Claim-only plan for private model/repository/formatting/tool-adapter ownership; no production implementation before effective claim merge. |
