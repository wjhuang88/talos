...
| I208 | Steering Boundary Insertion | Review / Claimed | `TUI-050`; claim/activation PR #487 merged as `75ca8057`; implementation PR #488 is under exact-head validation/review. |
