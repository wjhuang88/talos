...
| I036 | Research Consolidation | **Planned** | End-of-plan research-only iteration that consolidates REMOTE-001, WEB-001, PLUGIN-001, OKF-001, and MEM-005 into decisions, ADR candidates, and executable follow-up stories. See `I036-research-consolidation.md`. |
