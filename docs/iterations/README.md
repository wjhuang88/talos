...
| R29: High-Risk gix/Runtime/Governance Execution Set | Planned (2026-07-04) | `../tasks/2026-07-04-high-risk-execution-gix-runtime-governance-plan.md`; `I094-gix-upgrade-git-boundary.md`; `I095-runtime-validation-evidence.md`; `I096-governance-mutation-gates.md`; `I097-controlled-self-bootstrap-rehearsal.md`; `../backlog/active/GIT-001-embedded-git-tools.md`; `../backlog/active/RUNTIME-001-embeddable-agent-runtime-api.md`; `../backlog/active/GOV-003-builtin-project-governance.md`; `../backlog/active/REL-002-v1-self-bootstrap-release-gate.md` | Activate I094 only after explicit start and inventory disposition. No push, publish, tag, destructive Git operation, permission-default change, native Git dependency, or v1.0 claim without a separate explicit gate. |
