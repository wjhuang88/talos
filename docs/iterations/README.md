...
| I213 | Dashboard Live Activity And Log Viewer | Active / Claimed | Activation PR #363 merged as `e578f419`. Controlled pairwise exceptions are I219 permission execution, I220 decision-only ADR-067 docs and I222-B core/agent/tools/runtime work excluding I213 production files. Authority/production overlap stops only the affected lane; each lane requires separate exact-head CI/review/CAS. |
...
| I222 | TOOL-024-B Managed Background Execution Core | Active / Claimed | PR #379 merged as `48e8ae9b` after CI `32650593056`, review `5386970071` and CAS; bounded parallel pair with I213 under `5386904546`; Unix non-daemonizing core with no CLI/Dashboard/Windows spawn. |
