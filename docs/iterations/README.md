...
| I203 | v0.8.0 GitHub And Crates.io Publication | Active / In Progress / Claimed | Claim PR #262 merged as `f6b2d243` after I204 reviewed conditional GO. Implementation must start from this activation head and receive independent exact-head review; GitHub Release with five assets/checksums must complete before the first real Cargo publish. |
