...
| I177 | Agent Session Custody Decomposition | Planned | ARCH-034-R08 selected after I176 closeout; governance-only claim PR #161 proposes ownership. No implementation authority exists until the finalized claim merges to `main`. |
