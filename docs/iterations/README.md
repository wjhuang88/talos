...
| I031 | Skill Runtime Activation And CLI Cleanup | **Planned** | Complete ARCH-009, then wire SKILL-001 so normal CLI/TUI startup discovers skills and injects Level 0 metadata before the first turn. See `I031-skill-and-cli-module-cleanup.md`. |
...
| R18: Skill Runtime Activation | After R17 | `I031-skill-and-cli-module-cleanup.md`; `../backlog/active/ARCH-009-skill-module-decomposition.md`; `../backlog/active/SKILL-001-runtime-skill-activation.md` | `talos-skill` is decomposed and normal sessions discover/inject skills before first turn. |
...
| R21: MCP Session Integration | After R18 or in parallel with R20 if startup path is stable | `I034-mcp-session-integration.md`; `../backlog/active/MCP-001-session-mcp-integration.md` | MCP tools are discovered at session startup, registered with provenance, and routed through permissions. |
