...
| I198 | Optional Skill Triggers Compatibility | Review / Claimed | Issue #155 / SKILL-004; claim #324 merged as `ea668685`. Bounded implementation and full preflight pass; exact-head PR gates and Issue #302 human validation remain open. |
