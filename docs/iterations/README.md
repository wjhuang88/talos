...
| I253 | Capability Architecture Governance Convergence | Review / Claimed (effective via #518 merge `53fc57b3`) | [I253](I253-capability-governance-convergence.md) / CAP-001-G / Issue #519 (parent #466); local audit candidate is complete pending independent review and closeout; child Issues #508-#517 remain separately governed, with no child implementation authority. |
