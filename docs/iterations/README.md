...
| I197 | Permission Prompt Layout Anchor Stability | Active / Claimed; implementation PR #305 in Review | Issue #125 / TUI-045; claim #304 merged as `0db92cf9`, implementation head `c394a1a2`; human/manual rows remain deferred to Issue #302 / I211. |
...
| I201 | Tool-Call Placeholder Suppression | Active / Claim Pending | Issue #111 / TUI-043; governance-only claim proposed from `main@8069ea6a`; no implementation branch or behavior authority exists before merge. |
