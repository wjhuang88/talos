...
| I205 | PR Workflow Throughput Simplification | Active / Claimed / PR #284 | Claim merge `fd1eaad9`; sole Active evidence-only governance Spike. Every executable rule change remains excluded and needs a new bounded claim. |
