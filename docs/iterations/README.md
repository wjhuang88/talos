...
| I162 | v0.6 SDK Fixture And Publication Readiness | Planned / Claimed | Claim PR #253 proposes the readiness-only scope; ineffective until merge. No real publish/tag/release. |
