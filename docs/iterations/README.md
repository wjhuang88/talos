...
| I189 | PERM-006-A Structured Permission Decisions | Active / Claimed (effective only after PR #351 merge) | Claim merge `0df88638` is effective. Governance-only PR #351 authorizes only the behavior-preserving structured evaluator after it reaches `main`; protected-scope implementation review remains mandatory. |
...
| I218 | Auto Permission Security Decision | Active / Claimed | Claim PR #352 merged as `ca30081a`; threat matrix and Proposed ADR-064 are decision-only. Exact-head security review gates acceptance; no executable behavior or later child authority. |
