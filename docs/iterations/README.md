...
| I217 | Ordered Finalizer Registry And Durable Closure | Review / Claimed | RUNTIME-005-C; implementation commit `44e840d7` is in PR #348 after full local preflight. Exact-head CI, independent runtime architecture review and merge-time CAS remain. |
