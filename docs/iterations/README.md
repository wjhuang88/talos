...
human UX acceptance is partial pending filesystem no-effect evidence for timeout/Esc cancellation. MODEL-007 follows, not activated; #590 is separate intake.
