...
| I202 | Dashboard Availability In The Logo Prefix | Active / Claimed | Claim PR #229 merged as `d801c8d1`; implement TUI-037 / Issue #104 before the mainline long task. Current complete behavior is a token-free plain-text Logo row with no OSC 8 and no token logging; implementation exact-head review remains mandatory. |
