...
| I193 | SESSION-008-B Durable Partial-Turn Finalization | Planned / Unclaimed | Governance claim PR pending; no implementation authority before a finalized claim reaches `main`. R1/R2 are mandatory acceptance inputs; RUNTIME-005 remains blocked. |
