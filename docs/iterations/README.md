...
| I217 | Ordered Finalizer Registry And Durable Closure | Planned / Unclaimed | RUNTIME-005-C; governance-only Draft claim preparation is Pending and ineffective. No implementation branch or production authority before finalized atomic claim+activation reaches `main`. |
