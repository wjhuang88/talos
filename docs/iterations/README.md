...
| I123 | Installation And Trial Confidence | **Review** (2026-07-13) | Month 4. Installer fixtures (POSIX 9/9 + PowerShell 5/0/1, checksum verified, offline/ARM64 error text asserted, runnable check gated to Windows), clean-HOME smoke (18/0/2, real session resume), and honest trial report. Back in Review after a second acceptance re-test: install.ps1 non-Windows false-success fixed; Windows real-run and independent-operator replay remain UNMET. See `I123-installation-and-trial-confidence.md`. |
