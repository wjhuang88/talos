...
| I201 | Tool-Call Placeholder Suppression | Active / Claimed | Issue #111 / TUI-043; claim #306 merged as `78cb1ddd` after exact-head CI, Agent governance review and CAS. Implementation has not started and must remain inside the published TUI-visible boundary. |
