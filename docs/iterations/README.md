...
| I180 | Architecture Documentation Truth | Planned | Governance-only claim PR #170 proposes `ARCH-034-R11` ownership; implementation is not authorized until the finalized claim merges to `main`. |
