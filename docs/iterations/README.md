...
| I190 | Change-Aware CI Routing | Planned / claim PR pending | [I190](I190-change-aware-ci-routing.md) selects only GOV-005: deterministic fail-closed documentation-only classification, stable CI routing and adversarial fixtures. No workflow implementation authority before target-branch claim merge. |
