...
| I244 | Active / Claimed (proposed in #465; ineffective until merge) | PERM-007-F generic shell auto-classifier implementation; no production changes before claim merge. |
