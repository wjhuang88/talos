...
| I210 | Provider Retry Progress Contract | Active / Claimed through PR #321 target merge; ineffective while open | PROVIDER-006 / Issue #278; ADR-062 and the bounded claim require independent exact-head review, CI and CAS. Implementation may start only after #321 reaches `main`; initial `Connecting…` then structured `Reconnecting… (attempt n/m)` must preserve retry policy. |
