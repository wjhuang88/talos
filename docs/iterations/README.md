...
| I211 | Deferred Human Review And Acceptance Batch | Active / Claimed proposed; ineffective before activation PR merge | VALIDATION-002 / Issue #302; claim #326 merged as `285fc3c7`. Activation starts there and grants evidence reconciliation only, not product repair authority. |
