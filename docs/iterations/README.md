...
| I238 | Completion Claim And Evaluation State Model | Review / Claimed | Claim PR #444 merged as `7a6b5ed4`; stable candidate `f813dc9a` is under implementation PR #445 review; P3-P4 remain blocked. |
