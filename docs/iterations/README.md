...
| I244 | Active / Claimed (claim #465 merged at `94ba2dc5`) | PERM-007-F generic shell auto-classifier implementation; production work is bounded by ADR-070 and the effective claim. |
