...
| I238 | Completion Claim And Evaluation State Model | Planned / Unclaimed proposal | WORK-001-C/P2 only; claim and activation are ineffective until governance PR merge. P3-P4 remain blocked. |
