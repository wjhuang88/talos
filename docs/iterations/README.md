...
| I023 | TUI State Model | **Review** (2026-06-11) | Event-driven architecture: `talos-conversation` + `talos-tui` separation. Codex-style `insert_history` with styled scrollback, 3-column prefix padding, multiline user messages with Nord bg color + top/bottom padding, animated braille spinner, native cursor sync. 110 tests pass (57 TUI + 53 conversation). See `I023-tui-state-model.md`. |
