...
| I189 | PERM-006-A Structured Permission Decisions | Review / Claimed / PR #356 | Claim merge `0df88638` and activation merge `20cfcce4` are effective. Implementation commit `6b577d6a` is pending exact-head CI, independent security/code review, CAS and owner-first closeout; no later child authority transfers. |
