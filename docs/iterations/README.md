...
| I085 | Model Catalog Modernization — talos-models, /model, /connect | **Active (2026-07-03; Stage 1)** | Activated after `v0.2.2` closeout. Stage 1 covers talos-models SQLite crate, correct models.dev parsing, gated refresh, and resolver precedence; `/model` and `/connect` remain Stage 2 after resolver tests. See `I085-model-catalog-modernization.md`. |
...
| I085 | Active | Activated 2026-07-03 after `v0.2.2` release closeout. Start with Stage 1 MC100-MC103; keep Stage 2 `/model` + `/connect` gated until resolver precedence tests pass. |
