...
| I220 | PERM-006-C Agent-Owned Pipeline Decision | Active / Claimed proposed by PR #370; ineffective until merge | Decision-only ADR-067/current-path/migration contract. Maintainer authorization permits non-overlap with I213; I213 owner drift remains a merge-time stop gate. I221 separately owns later implementation. |
