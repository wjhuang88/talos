...
| I092 | Context Compression And Autonomy Gates | **Active (2026-07-04)** | Month 3 of the direct senior-agent high-risk execution track. Cache-safe compression proof/rejection plus deny/ask/allow autonomy matrix. See `I092-context-compression-autonomy-gates.md`. |
...
| I092 | Active | Activated after I091 completion. Start with MEM-007 cache-stability proof/rejection, then autonomy permission matrix. |
