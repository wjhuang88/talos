...
| I198 | Optional Skill Triggers Compatibility | Active / Claimed via PR #324; ineffective while open | Issue #155 / SKILL-004; additive compatibility contract confirmed. Implementation may start only after the exact-head claim reaches `main`; no parser branch exists yet. |
