...
| I237 | Canonical Work Domain And Todo Compatibility | Planned / Unclaimed proposal | WORK-001-B/P1 claim PR #440 is proposed; claim/activation remains ineffective until merge to `main`. No implementation authorization yet. P2-P4 remain blocked. |
