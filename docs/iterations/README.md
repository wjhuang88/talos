...
| I162 | v0.6 SDK Fixture And Publication Readiness | Active / Claimed | Activated from `main@38127228` after claim PR #253 merge; readiness-only scope, no real publish/tag/release. |
