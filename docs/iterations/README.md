...
| I095 | Runtime Validation Evidence | **Active (2026-07-04)** | Add or specify durable validation execution evidence needed for Talos-primary development. See `I095-runtime-validation-evidence.md`. |
...
| I095 | Active | Activated 2026-07-04 after I094 closeout; runtime validation evidence only, with no permission-default or execution-policy expansion. |
...
| R29: High-Risk gix/Runtime/Governance Execution Set | In Progress (2026-07-04) | `../tasks/2026-07-04-high-risk-execution-gix-runtime-governance-plan.md`; `I094-gix-upgrade-git-boundary.md`; `I095-runtime-validation-evidence.md`; `I096-governance-mutation-gates.md`; `I097-controlled-self-bootstrap-rehearsal.md`; `../backlog/active/GIT-001-embedded-git-tools.md`; `../backlog/active/RUNTIME-001-embeddable-agent-runtime-api.md`; `../backlog/active/GOV-003-builtin-project-governance.md`; `../backlog/active/REL-002-v1-self-bootstrap-release-gate.md` | I095 active. No push, publish, tag, destructive Git operation, permission-default change, native Git dependency, execution-policy expansion, or v1.0 claim without a separate explicit gate. |
