...
| I197 | Permission Prompt Layout Anchor Stability | Review / Claimed - validation failed/incomplete | Issue #125 / TUI-045; implementation merged as `d98f37e7`. Complete/Closed I230/TUI-059 corrected composer-relative docking; I197 retains its separate deferred natural-person acceptance. |
...
| I201 | Tool-Call Placeholder Suppression | Review / Claimed - validation failed | Issue #111 / TUI-043; implementation merged as `7f5a6df2`. Permission-mediated suppression was corrected by Complete/Closed I229/TUI-058/#329; deferred natural-person acceptance remains separate, so I201 Completion Commit is Pending. |
...
| I210 | Provider Retry Progress Contract | Review / Claimed - implementation merged; human validation partial failure | PROVIDER-006 / Issue #278; PR #323 merged as `9d5c8a71`. Complete/Closed I231/TUI-060 corrected initial connection and first-turn queue status; I210 retains separate deferred natural-person acceptance. |
...
| I232 | Invalid Skill Diagnostic Visibility | Planned / Unclaimed | SKILL-005/#333 corrective iteration; claim preparation from `main@88261365`; no implementation authorization until claim merge. |
