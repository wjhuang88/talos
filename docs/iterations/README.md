...
| I023 | TUI State Model | **Review** (2026-06-10) | Event-driven architecture: `talos-conversation` + `talos-tui` separation. Codex-style `insert_history`, stream-based content delivery, single-directional flow. 93 tests pass (43 TUI + 50 conversation). Awaiting runtime verification of insert_history rendering. See `I023-tui-state-model.md`. |
