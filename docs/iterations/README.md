...
| I238 | Completion Claim And Evaluation State Model | Review / Claimed | Claim PR #444 merged as `7a6b5ed4`; stable candidate `b08358e6` awaits implementation PR review; P3-P4 remain blocked. |
