...
| I085 | Model Catalog Modernization — talos-models, /model, /connect | **Paused (2026-07-04; MC107 manual TUI residual)** | Stage 1 complete. Stage 2 core gaps and post-review fixes landed: catalog-backed `/connect` with optional `base_url`, group-aware filtering, `/model` auth-only rows, slash prefix selection, implicit first-access `catalog.db` seed, and README onboarding. Remaining residual: real terminal `/connect` walkthrough. See `I085-model-catalog-modernization.md`. |
...
| I090 | High-Risk Ingestion And Search Boundary | **Active (2026-07-04)** | Month 1 of the direct senior-agent high-risk execution track. Activated after I085 was explicitly paused. Bounded document extraction/search only, no browser/PDF/Office/OCR scope. See `I090-high-risk-ingestion-search-boundary.md` and `../tasks/2026-07-04-architect-owned-four-month-high-risk-execution.md`. |
| I091 | Plugin, Hook, And Distribution Boundary | **Planned (2026-07-04)** | Month 2 of the direct senior-agent high-risk execution track. Local diagnostics and distribution policy only; no remote install, marketplace, write-capable plugin tools, or auto-discovery. See `I091-plugin-hook-distribution-boundary.md`. |
...
| I090 | Active | Activated after I085 was explicitly Paused. Start with acceptance audit of existing `document_extract`, `fetch_url`/`save_url`, and ripgrep-backed `grep` before adding code. |
| I091 | Planned | Direct senior-agent high-risk track month 2. Activation blocked until I090 closes or is explicitly deferred. |
...
| R28: Architect-Owned Four-Month High-Risk Execution | Planned execution (2026-07-04) | `../tasks/2026-07-04-architect-owned-four-month-high-risk-execution.md`; `I090-high-risk-ingestion-search-boundary.md`; `I091-plugin-hook-distribution-boundary.md`; `I092-context-compression-autonomy-gates.md`; `I093-self-bootstrap-runtime-release-gate.md`; `../tasks/2026-06-28-architect-owned-high-risk-work-group.md` | I085 must close or be explicitly paused before I090 activation. No push, publish, tag, destructive cleanup, network spend, major dependency, permission-default change, browser/PDF/Office/OCR expansion, remote plugin install, or v1.0 claim without a separate explicit gate. |
