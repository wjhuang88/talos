...
| I216 | Bounded Shutdown Coordinator And Admission Fence | Active / Claimed proposed by #344; ineffective until merge | RUNTIME-005-B atomic governance-only claim+activation proposal. ADR-063/I214 and SESSION-008-B prerequisites are Complete; implementation starts only after the finalized claim reaches `main`. |
