...
| I183 | Bundled SQLite ADR Reconciliation | Complete | Completion Commit `edf903aa96574043294923ad60b0cefe9730f8c4`; final source `0d9a5a7b`, CI `31349520295`, independent review `5235367999` and merge-time CAS passed. R04 remains Partial; AG-11 and AG-12 are separately unclaimed. |
 ...
 | I186 | TUI Visible-Cell Selection And Copy | Review / PR #193 | [I186](I186-tui-visible-cell-selection.md) implements TUI-046-B / Issue #134: application-owned drag selection, cross-screen edge autoscroll, resize continuity, existing clipboard backend and strict input isolation. Exact head is bound by PR evidence; two-terminal acceptance remains pending. |
