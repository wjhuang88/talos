...
| I174 | TUI App Coordinator Decomposition | Planned / claim proposal | Governance-only proposal for private input, stream/output, and frame ownership; no implementation before effective claim merge. |
