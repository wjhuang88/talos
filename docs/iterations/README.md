...
| I189 | PERM-006-A Structured Permission Decisions | Active / Claimed (effective only after activation merge) | Claim merge `0df88638` is effective. The governance-only activation authorizes only the behavior-preserving structured evaluator after it reaches `main`; protected-scope implementation review remains mandatory. |
