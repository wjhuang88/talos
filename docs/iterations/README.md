...
| I210 | Provider Retry Progress Contract | Review / Claimed | PROVIDER-006 / Issue #278; implementation evidence `6efee2b8` provides initial `Connecting…` then structured `Reconnecting… (attempt n/m)` while preserving retry policy. Exact-head CI/review/CAS and #302 human validation remain open. |
