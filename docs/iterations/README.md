...
| I160 | Shared CLI And Runtime Internal Composition | Active / Claimed | Governance claim PR #238 merged as `71faf844`; implementation worktree `feat/runtime-I160-shared-composition` starts at that exact head. I161-I162 remain blocked in order. |
