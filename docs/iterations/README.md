...
| I213 | Dashboard Live Activity And Log Viewer | Active / Claimed | Activation PR #363 merged as `e578f419`. Existing I219/I213 protection remains; I220/I213 permits ADR-067 decision docs only, no Rust/Cargo/Dashboard/Runtime/permission behavior. Authority/production overlap stops work and each lane requires separate exact-head CI/review/CAS. |
...
| I220 | PERM-006-C Agent-Owned Pipeline Decision | Active / Claimed effective through PR #370 merge `5b8b1488` | Decision-only ADR-067/current-path/migration contract. Maintainer authorization permits non-overlap with I213. ADR-067 acceptance and I221 separately gate later implementation. |
