...
| I076 | Month 1 — Provider, Tooling, And Validation Loop | **Active (2026-07-01)** | Weeks 1-4 of the 2026-07-01 replan: provider usage, status display, write/edit output, model-switch markers, validation-loop design. First packet T100-T103 is underway. See `I076-month1-provider-tooling-validation.md`. |
