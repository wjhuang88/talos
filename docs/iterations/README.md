...
| I236 | PERM-007-D Cross-Surface Conformance | Active / Claimed (proposed; ineffective until claim merge) | PERM-007-D / Issue #188; conformance, rollout and rollback evidence only. |
