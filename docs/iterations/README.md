...
| I201 | Tool-Call Placeholder Suppression | Review / Claimed; implementation PR #309 | Issue #111 / TUI-043; implementation commit `68f4fb7b` is in Review after local locked tests and preflight. Exact-head CI/Agent review/CAS remain open; human suppression-safety validation is deferred to Issue #302 / I211. |
