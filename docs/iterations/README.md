...
| I175 | Conversation Engine Decomposition | Active | Claim PR #154 merged at `69c345f0` after exact-head CI `31150975042`; behavior-preserving command/projection source decomposition is in progress. R04 remains blocked; R07-R11 stay Ready/unclaimed. |
