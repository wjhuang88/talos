...
| I199 | Thinking Preview Wrap And Bounded Height | Review / Claimed | Issue #69 / TUI-041; implementation commit `938c9edb` is in PR #297 pending exact-head CI, maintainer native-terminal acceptance and independent review. No TUI-042/TUI-045 or provider/persistence authority. |
