...
| I197 | Permission Prompt Layout Anchor Stability | Review / Claimed - validation failed/incomplete | Issue #125 / TUI-045; implementation merged as `d98f37e7`. TUI-059/#330 owns the terminal docking/hierarchy failure and incomplete matrix. |
| I198 | Optional Skill Triggers Compatibility | Review / Claimed | Compatibility behavior passed, but SKILL-005/#333 owns the real-CLI malformed-`triggers` diagnostic failure. Completion Commit remains pending. |
...
| I201 | Tool-Call Placeholder Suppression | Review / Claimed - validation failed | Issue #111 / TUI-043; implementation merged as `7f5a6df2`. Permission-mediated suppression failed and is owned by TUI-058/#329; Completion Commit is Pending. |
...
| I213 | Dashboard Live Activity And Log Viewer | Active / Claimed proposed via #363; activation ineffective until merge | Claim PR #327 merged as `66747214`. #363 records fresh `main@781bb112` activation inventory and the maintainer-approved I219/I213 parallel exception. No implementation branch before #363 reaches `main`; Dashboard remains GET/read-only and cannot modify permission/runtime authority. |
...
| I219 | PERM-006-B First-Class Scoped Grants | Active / Claimed | PR #359 merged as `781bb112`; I219 exclusively owns the scoped grant/compiler/store, permission wrapper and public permission API/schema migration slice. The explicit I213 parallel exception transfers no permission authority; later PERM-006-C and TOOL-024 remain blocked. |
