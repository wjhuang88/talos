...
| I197 | Permission Prompt Layout Anchor Stability | Active / Claim Pending (#304) | Issue #125 / TUI-045; claim PR #304 proposes the layout-only activation from `main@99645e78`; no implementation branch exists until the claim merges. |
