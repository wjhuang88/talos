...
| I231 | Initial Connection And Queue Status Sequencing | Planned / Unclaimed | TUI-060/#332 corrective iteration; claim preparation from `main@34fcfeab`; no implementation authorization until claim merge. |
