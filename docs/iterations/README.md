...
| I120 | Dynamic Diagnostics Truth | **Active** (2026-07-13) | Month 1 of the 2026-07-13 frontline long task. Gate 0 passed. Valid JSON, dynamic iteration/gate truth, redaction, and safe malformed-source fallback. See `I120-dynamic-diagnostics-truth.md`. |
