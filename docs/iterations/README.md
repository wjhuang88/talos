...
| I245 | v0.9.0 GitHub And Crates.io Publication | Proposed Active / Claimed | REL-005 release slice from `main@336c65e0`; claim and activation remain ineffective until the finalized governance PR merges. GitHub Release must complete before Cargo publication. |
