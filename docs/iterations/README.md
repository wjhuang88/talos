...
| I243 | Active / Claimed (proposed in #463; ineffective until merge) | PERM-007-F0 decision-only shell classifier context/precedence contract; ADR-070 Proposed, no production authority. |
| I244 | Blocked / Unclaimed | PERM-007-F shell auto-classifier implementation; blocked on I243/ADR-070 and separate implementation claim. |
