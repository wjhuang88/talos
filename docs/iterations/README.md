...
| I196 | Canonical Work Domain Decision And Migration Contract | Planned / proposed claim | WORK-001-A P0 only. The Draft claim is ineffective until finalized with its actual PR number, independently reviewed and merged to `main`; no implementation branch, Work Graph, Evaluator, persistence or Desktop work is authorized. |
