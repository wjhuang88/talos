...
| I206 | Esc-Cancelled Steering Activation | Review / Claimed | Claim #410 merged as `c3a121f0`; local candidate activates one same-Session queued turn after requested Esc cancellation and restores provider switching after drain. Real-terminal, exact-head CI/review and merge remain pending. |
