...
| I171 | Workspace Architecture Rebaseline | Active | Claim #138 is effective; reproduce the v0.7.0 baseline, create bounded remediation owners, and complete locked validation; no production refactor. |
