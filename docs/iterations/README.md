...
| I174 | TUI App Coordinator Decomposition | Planned / Claim PR #151 | Proposed private input, stream/output, and frame ownership; claim is ineffective and implementation prohibited until PR #151 merges. |
