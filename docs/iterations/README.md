...
| I196 | Canonical Work Domain Decision And Migration Contract | Active / Claimed | PR #226 merged as `453d1fba`; activated from `main@b59912e3` for the P0 decision/documentation slice. No Work Graph, Evaluator, persistence, API, Desktop, Dashboard or TUI implementation authority. |
