...
| I201 | Tool-Call Placeholder Suppression | Review / Claimed - validation failed | Issue #111 / TUI-043; implementation merged as `7f5a6df2`. Permission-mediated suppression failed and is owned by Active/Claimed I229/TUI-058/#329, pending governance merge; Completion Commit is Pending. |
...
| I229 | Permission-Mediated Tool Activity Correlation | Review / Claimed | TUI-058/#329 implementation candidate commits `0459e268`/`2c390c6d` locally add approval-wait marker custody and named approval outcomes after claim PR #413 merged as `0e0c79ba`; exact-head CI/review remain pending. |
