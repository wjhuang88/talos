...
| I213 | Dashboard Live Activity And Log Viewer | Active / Claimed | Activation PR #363 merged as `e578f419` under the maintainer-approved I219/I213 parallel exception. Dashboard remains GET/read-only and cannot modify permission/runtime authority. |
...
| I219 | PERM-006-B First-Class Scoped Grants | Review / Claimed; stable candidate pending first push | Local convergence passed from claim merge `781bb112`, including real preflight, CLI/TUI/Runtime, public API migration and locked validation. Exact-head CI/review/CAS remain; I219 retains exclusive permission authority and I213 retains only its separate Dashboard lane. C and TOOL-024 stay blocked. |
