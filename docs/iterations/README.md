...
| I211 | Deferred Human Review And Acceptance Batch | Active / Claimed proposed via #328; ineffective while open | VALIDATION-002 / Issue #302; claim #326 merged as `285fc3c7`. Activation #328 starts there and grants evidence reconciliation only, not product repair authority. |
