...
| I038 | Model Catalog Foundation | **Active** (2026-06-20) | MODEL-001: built-in model dataset + models.dev import. Catalog-only (reasoning split to MODEL-003). See `I038-model-catalog-foundation.md`. |
...
| I036 | Complete | Activated 2026-06-20 of the current plan; no implementation code belongs to this research iteration. |
...
| R24: Model Catalog Foundation | Active (2026-06-20) | `I038-model-catalog-foundation.md`; `../backlog/active/MODEL-001-model-catalog-and-reasoning.md` | Built-in model dataset + models.dev import; catalog-only, reasoning split to MODEL-003. |
