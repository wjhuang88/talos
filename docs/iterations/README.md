...
| I180 | Architecture Documentation Truth | Planned | Governance-only claim preparation proposes `ARCH-034-R11` ownership; implementation is not authorized until a finalized claim merges to `main`. |
