...
| I251 | Pre-Provider Rejection Terminalization | Planned / Claimed (proposed; ineffective until claim merge) | [I251](I251-runtime007-preprovider-terminalization.md) / RUNTIME-007 / Issue #499; runtime implementation starts only after atomic claim activation reaches `main`. |
