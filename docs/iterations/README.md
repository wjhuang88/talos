...
| I124 | One-Shot Scheduled Follow-Up | **Review — changes required** (2026-07-14) | Validation ladder is green, but maintainer review found raw delay registrations bypass approval wrappers, fixture-provider/real-session proof is absent, and the implementation expands the public API contrary to the baseline. See `I124-one-shot-scheduled-followup.md` and `docs/reference/I124-PRE-ACTIVATION-SECURITY-NOTE-2026-07-13.md`. |
...
| I124 | Review — changes required (2026-07-14) | Fix approval-wrapper bypass, add real conversation/permission proof, resolve the public-API variance, and record the three I127 limitations before re-review. |
