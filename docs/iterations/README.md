...
| I220 | PERM-006-C Agent-Owned Pipeline Decision | Planned / Unclaimed | Decision-only ADR-067/current-path/migration contract. A/B are Complete, but activation waits for explicit I213/I220 scheduling authorization or I213 leaving Active. I221 separately owns later implementation. |
