...
| I031 | Skill And CLI Module Cleanup | **Planned** (CLI slice remaining) | ARCH-009 skill split was pulled forward on 2026-06-19; remaining scope is the CLI slice of ARCH-010: extract CLI mode runners. See `I031-skill-and-cli-module-cleanup.md`. |
...
| I033 | Runtime Skill Activation | **Planned** | Wire SKILL-001 so normal CLI/TUI startup discovers skills and injects Level 0 metadata before the first turn. See `I033-runtime-skill-activation.md`. |
...
| R18: Skill And CLI Cleanup | Partially pulled forward; CLI next | `I031-skill-and-cli-module-cleanup.md`; `../backlog/active/ARCH-009-skill-module-decomposition.md`; `../backlog/active/ARCH-010-cli-tools-module-cleanup.md` | ARCH-009 is complete; remaining gate is CLI mode-runner decomposition with targeted tests/clippy. |
...
| R20: Runtime Skill Activation | After R19 | `I033-runtime-skill-activation.md`; `../backlog/active/SKILL-001-runtime-skill-activation.md` | Normal sessions discover/inject skills before first turn; Level 1/2 activation path is defined. |
