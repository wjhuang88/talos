...
| I179 | Core Tool Facade Decomposition | Review | Claim PR #167 merged as `9a5419e4` after exact-head CI `31183822345`; behavior-preserving private source decomposition and public-path probes pass locally, with implementation PR creation pending. |
