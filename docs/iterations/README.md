...
| I234 | Bounded Model-Assisted Permission Resolver | Active / Claimed (proposed) | PERM-007-C / Issue #188; protected create-only resolver, redacted schemas, atomic no-clobber and fail-closed circuit; claim ineffective until governance merge. |
| I235 | PERM-007-C Atomic Create Capability Decision | Active / Claimed | Decision-only prerequisite for I234; chooses a reviewed directory-capability primitive and platform fail-closed boundary. Claim PR #432; no implementation authority. |
