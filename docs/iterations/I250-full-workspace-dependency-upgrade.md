...
| Handoff / Release Condition | #501 awaits final independent review and merge-time CAS; after merge advance the accepted baseline and close owner-first using existing implementation evidence |
