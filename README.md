...
| I023 | TUI State Model | Review | Event-driven `talos-conversation` + `talos-tui` state model, styled multiline scrollback, spinner, and cursor sync. Final runtime verification remains before Complete. |
