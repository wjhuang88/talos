...
| Area | State | Notes |
|------|-------|-------|
| Runtime | Active | 519 tests passing across 12 crates. TTY launches the Nord-themed TUI by default; `--repl` keeps the legacy readline loop. |
| R1 Review Closure | Complete | I008/I009 closed. I009 TUI consumer work deferred to #I009-S6. I010 R2 is next. |
...
| I010 Polished Agent | Active (R2) | Codex-like inline terminal mode, AppServerSession convergence, TUI polish, markdown, diff display, slash commands. |
...
| I010 | Polished Agent | Active (R2) | Codex-like terminal UX and release-grade TUI workflows. |
