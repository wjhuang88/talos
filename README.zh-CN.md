...
Talos 已发布第一条稳定的 pre-1.0 release 线。当前工作区版本是 `v0.9.1`。它已经可以用于
...
`v0.9.1` 适合本地开发者在自己机器上使用，并由操作者审查工具动作和配置。它还不是远程多用户服务、
...
```bash
./scripts/release_preflight.sh v0.9.1
```
...
`v0.9.1` release 公告和下载以 GitHub Releases 为准。
